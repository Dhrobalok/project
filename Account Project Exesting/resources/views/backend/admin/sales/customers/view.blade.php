            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <div class="btn-group">
                                <a class="custom-btn bg-primary border-0 mr-2"
                                    href="{{ route('admin.sales.customers.index') }}">Back</a>
                                <a class="custom-btn"
                                    href="{{ route('admin.sales.customers.edit',['customer_id' => $customer -> id]) }}">Edit</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4 text-center">
                        <div class="col-md-12">
                            <p class="f-100 font-weight-bold text-black">{{ $customer -> name  }}</p>
                        </div>
                    </div>
                    <div class="row mb-4 text-center">
                        <div class="col-md-12">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4">
                            <p class="f-100">{{ $customer -> mobile_number }}</p>
                        </div>
                        <div class="col-md-2">
                            <p class="f-100">Phone</p>
                        </div>
                        <div class="col-md-4">
                            <p class="f-100">{{ $customer -> phone_number }}</p>
                        </div>
                    </div>
                    <div class="row text-center">
                        ...
                        <div class="col-md-4">
                            <p class="f-100">{{ $customer -> email_address }}</p>
                        </div>
                        <div class="col-md-2">
                            <p>Tax ID</p>
                        </div>
                        <div class="col-md-4">
                            <p class="f-100">{{ $customer -> tax_id }}</p>
                        </div>
                        ...
                        <div class="col-md-4">
                            <p class="f-100">{{ $customer -> tin_id }}</p>
                        </div>
                        <div class="col-md-2">
                            <p>Bin ID</p>
                        </div>
                        <div class="col-md-4">
                            <p class="f-100">{{ $customer -> bin_id }}</p>
                        </div>
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4">
                            <p class="f-100">{{ $customer -> country }}</p>
                        </div>
                        <div class="col-md-2">
                            <p class="f-100">Street</p>
                        </div>
                        <div class="col-md-4">
                            <p class="f-100">{{ $customer -> street }}</p>
                        </div>
                    </div>
                    <div class="row text-center">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-4">
                            <p class="f-100">{{ $customer -> city }}</p>
                        </div>
                        <div class="col-md-2">
                            <p>State</p>
                        </div>
                        <div class="col-md-4">
                            <p class="f-100">{{ $customer -> state  }}</p>
                        </div>
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4">
                            <p class="f-100">{{ $customer -> zip_code }}</p>
                        </div>
                        ...
                        <div class="col-md-4">
                            <p class="f-100">{{ $customer -> website }}</p>
                        </div>
                    </div>
                    <div class="row text-center">
                        <div class="col-md-2">
                    ...
                    <div class="row text-center">
                        <div class="col-md-6">
                            @foreach($customer -> bank_accounts as $customer_bank_account)
                            <div class="row">
                                <div class="col-md-6">
                                    <p>{{ $customer_bank_account -> bankinfo -> bank_name }}</p>
                                </div>
                                <div class="col-md-6">
                                    <p>{{ $customer_bank_account -> account_number }}</p>
                                </div>
                            </div>
                            @endforeach
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    @php
                                    $receivable_account = App\Models\ChartOfAccount :: find($customer ->
                                    account_receivable);
                                    @endphp
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    @php
                                    $payable_account = App\Models\ChartOfAccount :: find($customer -> account_payable);
                                    @endphp
