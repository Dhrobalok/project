        ...
        <ul class="nav navbar-right navbar-top-links">
            <li class="dropdown navbar-inverse">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <i class="fa fa-bell fa-fw"></i> Notification &nbsp<span class="badge">{{$m+$n+$l+$r}}
                    </span>
                </a>
                        ...
                        <a href="#">
                            <div>
                                ...
                                @foreach($j as $h)
                                 ...
                                 {{$h->session}} session ->
                               {{$h->semester}} Semester -> Improve Apply
                                ...
                                @endforeach
                                 ...
                                 {{$x->session}} session ->
                               {{$x->semester}} Semester  Regular Result Add
                                ...
                                @endforeach
                                 ...
                                 {{$y->session}} session ->
                               {{$y->semester}} Semester Apply For Exam(Regular)
                                ...
                                @endforeach
                                 ...
                                 {{$c->session}} session ->
                               {{$c->semester}} Semester Apply For improve
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li class="divider"></li>
                    <li><a href="{{URL::to('/suparLogout')}}"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                    </li>
                </ul>
            </li>
        </ul>
