...
<div id="page">
  ...
  <div class="header-top">
    ...
    <img src="pust_logo.png" style="width:160px; height:140px;" alt="Home" class="" />
     </div>
     <div style="width:70%;float:left;">
      <h2>
          <span style=" font-size:25px; color:#B84C4C; font-style:italic; text-transform:uppercase;">
...
<li><a class="css3 tab" href="{{URL::to('/about')}}">About Us</a></li>
  ...
  <section class="child clearfix">
    <section class="section"><a href="http://cse.pust.ac.bd/people/teachers/"> Teacher </a></section>
    <section class="section alt"><a href="http://cse.pust.ac.bd/people/staffs/">Staffs</a></section>
  </section>
  </li>
  

  
  <li><a class="css3 tab" href="contact_us.php">Contact</a></li>
  <li><a class="css3 tab" href="#">Login</a>
  <section class="child clearfix">
    
    <section class="section alt"><a href="{{ route('login') }}"> Student's Login </a></section>
  ...
  <div id="main">
      ...
      <nav class="breadcrumb" role="navigation"><h2 class="element-invisible">You are here</h2><ol><li><a href="">Home</a> › </li><li><a href="{{URL::to('/contact')}}" class="active"> Contact</a></li></ol></nav>      <div id="content" class="column" role="main">
                <a id="main-content"></a>
...
<div class="ds-1col node node-article view-mode-full view-mode-full clearfix ">
  ...
  <div id="node-article-full-group-left-content" class="group-left-content field-group-div"><div class="field field-name-body field-type-text-with-summary field-label-hidden"><div class="field-items"><div class="field-item even">
  <p>For media information and inquiries, please contact:</p>
  <p><b>Department of Computer Science And Engineering</b></p>
  <p>
  
     Engineering Building, 4th Floor,<br/>Faculty of Engineering, Pabna University of Science And Technology , Bangladesh<br/>
    <b>Pabna-6600
Phone: 0731-64876 Web: www.pust.ac.bd</b>  
 ...
 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3644.5224488343283!2d89.2774072346631!3d24.01263503774682!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fe84f0ec23a72b%3A0x775d6cd53cbdad8b!2z4Kaq4Ka-4Kas4Kao4Ka-IOCmrOCmv-CmnOCnjeCmnuCmvuCmqCDgppMg4Kaq4KeN4Kaw4Kav4KeB4KaV4KeN4Kak4Ka_IOCmrOCmv-CmtuCnjeCmrOCmrOCmv-CmpuCnjeCmr-CmvuCmsuCmr-CmvA!5e0!3m2!1sbn!2sbd!4v1557909700609!5m2!1sbn!2sbd" width="800" height="440" frameborder="0" style="border:0" allowfullscreen></iframe>
  </p>
