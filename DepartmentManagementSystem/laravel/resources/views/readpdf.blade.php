    ...
    <div class="field-content">
      ...
      <div class="content_data">
       <div style="width:320px; float:left; padding-left:10px;"> 
          ...
          <hr/  style="padding:0px; margin:0px;">
            ...
            Published:New Class Routine<marquee>11/21/2019</marquee><br>
            
         @foreach($r as $d)

  
                    <br>
                  <embed src="{{ asset('uploads/file/'.$d->file) }}"style="height: 60px;width: 60px;"></embed>


      <!--<a href="{{URL::to('/download/'.$d->id)}}"><button class="btn btn-success">Download</button></a>-->
      ...
      @endforeach
            ...
            Advising Notice for  2019<span style="color:red;"> <br>
             <span style="color:#CCCCCC"><a href="system/admin00/login/file_upload/image/1556550887.pdf">Read more</a></span>
           </p>
