...
<div id="wrapper">
   ...
   <div class="table-bordered">  
                      ...
                      <p style="font-style: oblique; color: red; font-size: 20px; margin-left: 460px;">  Cse Students</p>
                <table class="table table-bordered" id="dynamic_field">  
                
                     
               <p style="text-align: center;">Total Course in the Semester {{$g}} &nbsp&nbsp GetCourseResult {{$i}}</p>
...
<tr>
    ...
    <th style="width:5%;text-align: center">Mark</th>
    <th style="width:5%;text-align: center">ClassTest1</th>
     <th style="width:5%;text-align: center">ClassTest2</th>
        <th style="width:5%;text-align: center">ClassTest3</th>
        <th style="width:5%;text-align: center">ClassAttendence</th
</tr>
</thead>
             @foreach($re as $t)
...
<tbody>
    ...
    <tr>
        <th style="text-align: center">{{$t->roll}} </th>
        <th style="width:5%;text-align: center">{{$t->course}}</th>
        <th style="width:5%;text-align: center">{{$t->mark}}</th>
            <th style="width:5%;text-align: center">{{$t->ct1}}</th>
                <th style="width:5%;text-align: center">{{$t->ct2}}</th>
                    <th style="width:5%;text-align: center">{{$t->ct3}}</th>
                        <th style="width:5%;text-align: center">{{$t->ca}}</th>
   ...
   @endforeach
                     ...
                     <div class="footer">
                      <p style="font-size: 20px;">Chairman Signature:</p>
                        ...
                        <form class="login100-form validate-form" enctype="multipart/form-data" action="{{url('/signature')}}" method="POST">
                    {{ csrf_field() }}
