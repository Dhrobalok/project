    ...
    <div class="col-md-5" style="padding: 80px;">
        ...
        <div class="card" id="card1">
            ...
            <div class="card-header">
                <h5 style="text-align: center;">Search Cement</h5>
              <form action="<?php echo e(route('cement.location')); ?>" method="POST" id="form-submit">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="minquantity" class="form-control" placeholder="MinQuantity" aria-label="Min" list="exampleList">
                        ...
                        <input type="text" name="maxquantity" class="form-control" placeholder="MaxQuantity" aria-label="Max" list="exampleList2">
...
$(document).ready(function (){
    ...
    $.ajax({
        url : "<?php echo e(route('Cementadress.find')); ?>",
        type : "get",
...
<?php echo $__env->make('backend.admin.userdashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\rajit_project\Reda_Construction\resources\views/backend/admin/uploadproject/cementupload/dashboard.blade.php ENDPATH**/ ?>