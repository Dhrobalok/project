...
?></h1>
    ...
    <div class="general">
      ...
      <h1>Total Teacher Apply for Registration  </h1>
       <div class="loader">
  ...
  <div class="card green" style="position: absolute;top:2px;margin-left: 220px; background-color: ;">
    <div class="additional">
      <div class="user-card">
        <div class="level center">
...
?></h1>
    ...
    <div class="general">
      <h1>Total Student Apply for Registrtion</h1>
      <div class="loader">
