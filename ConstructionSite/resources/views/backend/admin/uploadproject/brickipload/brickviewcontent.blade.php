...
button {
    ...
    <div class="col-md-4">
      ...
      <div class="card">
         <div class="card-header shadow-sm" style="width: 100%;">
            <p class="p-0 m-0 p-2 " style="text-align: center;font-size:15px;color:darkmagenta;"><strong  style="display: inline-block;">Brick Details</strong> </p>
         ...
         <div class="card p-3">
            <table class="table">
                <tbody class="text-center">
                    ...
                    <tr>
                        <td style="font-family: Franklin Gothic Medium">Brick&nbsp;View</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td style="font-family: Franklin Gothic Medium">Name:</td>
                        <td>:</td>
                        <td>{{ $projectall->brickname }}</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{ $projectall->bricksize }}&nbsp;Inches</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{ $projectall->price }} <span style="font-size: 27px;">&#2547;</span></td>
 ...
 $allBrick=App\Models\Brick::get();
@endphp


<h5 class="text-center text-secondary">SIMILAR BRICK</h5>
                            ...
                            <table class="table table-borderless w-100">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{URL('brick/view',$brickall->id)}}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="text-secondary ">{{$brickall->bricksize}}&nbsp;Inch&nbsp;Brick</h5>
                                    ...
                                    <tr>
                                        <td style="font-family: Franklin Gothic Medium;">Brick&nbsp;Size</td>
                                        <td>:</td>
                                        <td>{{$brickall->bricksize}}</td>
                                    </tr>
                                </tbody>
