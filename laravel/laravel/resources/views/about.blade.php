...
<li><a class="css3 tab" href="{{URL::to('/about')}}">About Us</a></li>
  ...
  <section class="child clearfix">
    <section class="section"><a href="http://www.du.ac.bd/academic/department_item_details/faculty/MIS" target='_blank'> Faculty Member </a></section>
    <section class="section alt"><a href="#"> Officer/ Staff </a></section>
  </section>
  </li>
...
<div id="views_slideshow_cycle_div_escap_featured_content-block_0" class="views-slideshow-cycle-main-frame-row views_slideshow_cycle_slide views_slideshow_slide views-row-1 views-row-odd">
  ...
  <div class="views-field views-field-field-featured-file">        
    <div class="field-content">
      <div class="preview">
         <div class="frame"><img style="background-repeat: repeat-y;"src="30171791_1999981213601776_4061735529238547289_o.jpg" alt="" title="" /></div>
      </div>
    </div>
  </div> 
  </div>
       ...
       <div style="width:320px; float:left; padding-left:10px;"> 
          ...
          <hr/  style="padding:0px; margin:0px;">
            ...
            Published:<br>
             ...
             Class Routine<span style="color:red;"> <br>
             <span style="color:#CCCCCC"><a href="{{URL::to('#')}}">Download</a></span>
            ...
            Advising Notice for  2019<span style="color:red;"> <br>
             <span style="color:#CCCCCC"><a href="#">Read more</a></span>
           </p>
           
                        <p style="padding:5px; border-bottom:1px dotted #ccc;">
            Published: <br>
            
            Class Routine  Semester 2019 <span style="color:red;"> <br>
             <span style="color:#CCCCCC"><a href="system/admin00/login/file_upload/image/1556550926.pdf">Read more</a></span>
           </p>
        ...
        <div style="width:640px; float:left; padding-left:10px;"> 
          <h2 class="block__title block-title"  style="padding:5px; margin:0px;"><marquee>Welcome to the Department of CSE</marquee></h2>
          <hr/  style="padding:0px; margin:0px;">
