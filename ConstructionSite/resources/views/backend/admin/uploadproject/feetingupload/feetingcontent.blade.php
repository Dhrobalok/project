...
#logo
{
    ...
    <div class="col-md-4">
      ...
      <div class="card">
         <div class="card-header shadow-sm" style="width: 100%;">
            <p class="p-0 m-0 p-2 " style="text-align: center;font-size:15px;color:darkmagenta;"><strong  style="display: inline-block;">Feetings Details</strong> </p>
            ...
            <table class="table">
                <tbody >
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td> <img class="p-2 zoom" src = "{{ URL :: to($allfeeting -> image) }}" id="logo" alt="Avatar" ></td>
                    </tr>
                    <tr>
                        <td style="font-family: Franklin Gothic Medium">Category:</td>
                        <td>:</td>
                        <td>{{ $allfeeting->category }}</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{ $allfeeting->price }}&nbsp;<span style="font-family: fantasy;">&#2547;</td>
      ...
      <div class="col-md-6">
         ...
         <div class="card">
            ...
            <div class="card-body">
                @php
                $company=App\Models\Compane::where('employe_id',$allfeeting->employee_id)->first();
               @endphp
                ...
                {{-- <div class="row justify-content-center">
                    ...
                    <p class="py-2" style="text-align: center;">
                        <strong style="color:darkgray;">{{ $allfeeting->description }}
  ...
  <div class="col-md-4 py-4">
    ...
    <div class="card">
      ...
      <div class="card-body">
          <p class="text-center">
             @php
                Mapper::map($allfeeting->lat, $allfeeting->lng);
             @endphp
               ...
               <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                      ...
                      $employeeimage=App\Models\Employee::where('id',$allfeeting->employee_id)->first();
                    ...
                    <p style="font-size: 17px;color:black;text-align:center; width:bold;">
                      <b>Iteam&nbsp;{{ $allfeeting->productitem }}&nbsp;In {{ $allfeeting->address }}</b>
                    ...
                    <p style="font-size: 17px;color:black;text-align:center; width:bold;">
                      @php
                        $email=App\Models\User::where('id',$allfeeting->employee_id)->first();
                      ...
                      <div class="card-header" style="height:width:25%">
                        ...
                        <form action="{{ url('savecontact') }}" method="POST">
                          ...
                          <div class="form-group py-3">
                            ...
                            <input type="hidden" name="size" value="{{ $allfeeting->productitem }}">
                            <input type="hidden" name="id" value="{{ $allfeeting->employee_id }}">
  ...
  $allBrick=App\Models\Fiting::get();
 @endphp


 <h5 class="text-center text-secondary">SIMILAR FEETING</h5>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="{{URL('sanitary/view',$brickall->id)}}" class="text-center">
                                                <img src="{{ URL :: to($brickall -> image) }}" alt="">
                                             </a>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <h5 class="text-secondary ">{{$brickall->productitem}}&nbsp;</h5>
