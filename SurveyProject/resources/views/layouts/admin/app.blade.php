...
<head>
    ...
    <style>
      ...
      */
      ...
      {
        /* font-family:'Gentium Basic'; */
        background-image: url('{{ asset('company_pic/dc9a236a5915ab0bbbc2f6689dd6884b-s.webp') }}');
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('Admin.login') }}"><span style="font-weight: bold;color:cornsilk;">Login</span></a>
                                </li>
                            @endif
