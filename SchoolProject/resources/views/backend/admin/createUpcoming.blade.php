        ...
        <div class="col-md-6 mt-5">
             ...
             <div class="card shadow p-3">
                        ...
                        <div align="right" >
                            ...
                            href="{{route('Upcoming.course')}}"><i class="fas fa-arrow-circle-left"></i>
                            Back</a>

                        </div>


               <form action="{{route('UpcomingCreate')}}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="card-body">
                    <div class="row justify-content-start">
                        <div class="col-md-6">
                            <label for="">Upcoming Course</label>
                    ...
                    <div class="row group-form justify-content-center">
                      ...
                      <div class="input-group hdtuto control-group lst increment" >
                          <input type="text" name="name[]" class="myfrm form-control" placeholder="Course Name">&nbsp;&nbsp;
