         ...
         <div class="Banner">
             ...
             <div class="col-lg-12">
               @if(Session::has("alert"))
                   ...
                   <p style="text-align: center; font-style: oblique; font-size: 20px;"> @ All Notice @ </p>     
  ...
  <tr>
   ...
   <td>
      ...
      <td>
        ...
        <td>
            <a href="{{URL::to('/noticedelet/'.$d->id)}}"> <button class="btn btn-primary"><i class="far fa-trash-alt"></i> &nbsp Delete </button></a>
        </td>
 ...
 <tr>
   <td>
      ...
      <td>
        ...
        <td>
            <a href="{{URL::to('/noticedelet/'.$e->id)}}"> <button class="btn btn-primary"><i class="far fa-trash-alt"></i> &nbsp Delete </button></a>
        </td>
