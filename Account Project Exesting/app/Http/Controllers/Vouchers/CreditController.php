...
class CreditController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.admin.vouchers.credit_vouchers.create',['customers' => $customers,'logged_employee' => $logged_employee,'company_details' => $company_details,'employees' => $employees,'banks' => $banks]);
    }
