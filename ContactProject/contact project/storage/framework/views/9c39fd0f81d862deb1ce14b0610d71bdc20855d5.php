                ...
                <div class="content-side">
                    <ul class="nav-main">
                        <li class="nav-main-item">
                         ...
                         <?php if($id==2): ?>
                            <li class="nav-main-item ">
                                <a class="nav-main-link" href="<?php echo e(route('rolesetting')); ?>">
                                    <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                            ...
                            <li class="nav-main-item ">
                                <a class="nav-main-link" href="<?php echo e(route('category.inform')); ?>">
                                    <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                            ...
                            <li class="nav-main-item ">
                                <a class="nav-main-link" href="<?php echo e(url('addcategory')); ?>">
                                    <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                            ...
                            <li class="nav-main-item ">
                                <a class="nav-main-link" href="<?php echo e(url('designation')); ?>">
                                    <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                            ...
                            <li class="nav-main-item ">
                                <a class="nav-main-link" href="<?php echo e(url('newoffice')); ?>">
                                    <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                            ...
                            <li class="nav-main-item ">
                                <a class="nav-main-link" href="<?php echo e(route('indexadd')); ?>">
                                    <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                          ...
                          <?php endif; ?>
                            <?php
                             ...
                             <?php elseif($permission_id->permission_Id==3): ?>
            ...
            <div class="content-header">
                ...
                <div>
                 ...
                 <div class="dropdown">
                   ...
                   <a class="dropdown-item" href="<?php echo e(url('category.add',$category->id)); ?>"><?php echo e($category->category_name); ?></a>
                 ...
                 <div>
                  <div class="dropdown">
                    <a class="btn btn-primary dropdown-toggle f-100" href="#" role="button" id="accounting" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <?php echo e(Session::get('authmail')); ?>
...
<?php /**PATH F:\laragon\www\rajit_project\Ru_emergency_contact\resources\views/backend/admin/index.blade.php ENDPATH**/ ?>