...
class Employee extends Model
{
    ...
    protected $fillable = ['e_id','name','department_id','user_id','employee_photo','email','gender','mobile_no','date_of_birth','designation_id','joining_date','employee_number','payscale',
                        ];
