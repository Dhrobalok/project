...
<div class="container-fluid mb-4">
    ...
    <div class="card mb-2">
            <div class="card-header bg-white">
               <div class="row">
                   <div class="col-md-6">
                     <a class = "mr-4" href = "{{ route('admin.voucher.expenditure.index') }}" style = "color:blue;font-weight:500;font-size:22px"><i class = "fa fa-arrow-circle-left mr-2"></i>Back</a>
                   </div>
                   <div class="col-md-6 text-right">
                     <a class = "mr-2" href = "{{ route('admin.voucher.expenditure.edit',['id' => $voucher -> id]) }}" style = "color:blue;font-weight:500;font-size:22px"><i class = "fa fa-pencil-alt mr-2"></i>Edit</a>
                   </div>
               </div>
            </div>
        </div>
        <div class="card">
            <div class="card-header f-roboto">
                <div class="row">
                    <div class="col-md-12">
                        <strong>Expenditure Voucher</strong>
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-7 bg-white">
                        <strong class="f-100 font-weight-normal" style="font-size:18px;">{{ $voucher -> vendor ? $voucher -> vendor -> name : '' }}</strong>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-md-5 text-right">
