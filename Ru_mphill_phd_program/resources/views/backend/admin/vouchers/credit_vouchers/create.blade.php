...
<div class="container-fluid">
    ...
    <div class="card" id="create-tab">
        <div class="card-header bg-light">
            <div class="row">
                <div class="col-md-8">
                    <strong class="f-roboto mt-3">Receive Voucher</strong>
                </div>
    ...
    <div class="card" id="preview-tab" style="display:none">
        <div class="card-body">
            ...
            <div class="row text-center text-black">
                <div class="col-md-12">
                    <label class="f-roboto" style="font-size:25px;">Credit Voucher</label>
                </div>
            </div>
            <div class="row text-center text-black">
                <div class="col-md-12">
                    <label class="f-100" style="font-size:25px;">Institute Of Biological Science</label>
                </div>
            </div>
            <div class="row text-center text-black form-group">
                <div class="col-md-12">
                    <label class="f-100" style="font-size:20px;">Rajshahi-6205,Bangladesh</label>
                </div>
            </div>
            ...
            <div class="row text-center">
                <div class="col-md-6">
                    <p class="text-black"><strong>Customer : </strong><span id="paid_to"></span></p>
                </div>
                <div class="col-md-6">
...
$(document).ready(function() {
    ...
    $('#credit_voucher_form').submit(function(e) {
        e.preventDefault();
        ...
        if (confirm('Are you sure to post that voucher?')) {
            ...
            $.ajax({
                url: "{{ route('admin.voucher.credit.store') }}",
                type: "post",
                data: voucherData,
                processData: false,
                contentType: false,
                success: function(message) {
                    $('#credit_voucher_form')[0].reset();
                    $('#entries').html('');
...
$('#preview').click(function(e) {
    ...
    $('#paid_to').html($('#customer_id option:selected').text());
