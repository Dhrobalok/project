                            ...
                            @foreach ($allupcoming as $slider)
                                <tr>
                                    ...
                                    <td>
                                         <div class="d-flex">
                                            @can('delete')
                                            <a href="{{route('delete.seminar',$slider->id)}}" class="btn-danger btn-sm active" onclick="return confirm('Are you sure?')"><i class="fas fa-times"></i>&nbsp;Delete</a>
