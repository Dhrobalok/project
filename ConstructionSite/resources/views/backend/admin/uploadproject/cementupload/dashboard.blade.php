    ...
    <div class="col-md-5" style="padding: 80px;">
        ...
        <div class="card" id="card1">
            ...
            <div class="card-header">
              ...
              <form action="{{ route('cement.location') }}" method="POST" id="form-submit">
                    @csrf
                ...
                {{-- <div class="py-2">
                    <input type="text" name="quantity" id="size" class="form-control" placeholder="quantity" >
                </div>
                <div class="py-2">
