...
class ReportManager extends Controller
{
    ...
    public function trial_balance_report_start()
    {
       ...
       //$company = CompanySettings :: find(1);
        ...
        return view('backend.admin.reports.accounts.trial_balance_report_start',['accounts' => $accounts]);
        /*
    ...
    public function  trial_balance_pdf(Request $request)
    {
        ...
        $accounts = Ledger :: distinct()  -> get(['coa_id']);
       // $bulk_order=BulkOrder::all();
        $content = view('backend.admin.reports.trial_balance',['accounts' => $accounts,'company' => $company]);
    ...
    public function cash_book_report_start()
    {
        ...
        return view('backend.admin.reports.accounts.cash_book_report_start',['cashbook'=>$cash]);
        // return view('backend.admin.reports.accounts.cash_book_report_start',['debit_entries' => $debit_entries,'credit_entries' => $credit_entries,'max_cnt' => $max_cnt]);
    }
    ...
    public function cash_book_report_download(Request $request)
    {
        ...
        $content =  view('backend.admin.reports.accounts.cash_book_report_pdf',['cashbook'=>$cash]);
        $pdf = new \Mpdf\Mpdf(['margin_header' => -10]);
        $pdf -> WriteHtml($content);
