        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="f-roboto">Update Section</div>
                        </div>
                        <div class="col-md-4 text-right">
                            <a href="{{ route('admin.employees.section.index') }}"
                                class="btn btn-primary btn-sm f-100 text-white"><i
                                    class="fa fa-arrow-left mr-2"></i>Back</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.employees.section.update',['section_id' => $section -> id]) }}"
                        method="post">
                        @csrf
