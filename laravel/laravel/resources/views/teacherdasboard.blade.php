                    ...
                    <li>
                        <a href="#">
                            <div>
                                ...
                                @foreach($p as $b)
                                 This {{$b->session}} Session {{$b->semester}} 
                                 Semester  {{$b->course}}&nbspCourse Apply For Improve
                                 <br>
                                @endforeach
...
<p style="font-style: oblique; font-size: 16px;">
           <?php

           echo "<b style=color:red;>Your Exam Guard Date &nbsp :&nbsp</b>";
          foreach($k as $v)
        ...
        echo "".$e. "&nbsp Remain &nbsp".$x."&nbsp Days &nbsp&nbsp /";
...
?>
    ...
    <div class="general">
      ...
      <h1>Total Visitor As Teacher</h1>
           
           <div class="loader" style="margin-left: 40px;">
...
<div class="teacher" style="position: absolute;top:2px;margin-left: 190px; background-color: ;">
...
?>
    ...
    <div class="general">
       ...
       <marquee width="60%" direction="down" height="180px"  behavior="scroll" direction="up" scrollamount="4">
          ...
          <td><img src="{{ asset('uploads/pic/' . $k->image) }}" style="height: 
                        40px;width: 40px;"></td> 
