...
<div class="container-fluid">
        ...
        <div class="card-header bg-white">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <a class="mr-2" href="{{ route('admin.voucher.credit.view',['id' => $voucher -> id]) }}"
    ...
    <div class="card" id="create-tab">
        <div class="card-header bg-light">
            <div class="row">
                <div class="col-md-8">
                    <strong class="f-roboto mt-3">Credit Voucher</strong>
                </div>
                        ...
                        <tr>
                            ...
                            <td style="width:20%">
                                <input type="number" class="form-control" name="amounts[]"
                                    value="{{ $voucher_detail -> credit_amount }}" required>
                            </td>
                            <td>
...
$(document).ready(function() {
    ...
    $('#credit_voucher_form').submit(function(e) {
        ...
        if (confirm('Are you sure to post that voucher?')) {
            ...
            $.ajax({
                url: "{{ route('admin.voucher.credit.update',['id' => $voucher -> id]) }}",
                type: "post",
                data: voucherData,
                processData: false,
                contentType: false,
