            ...
            <!-- ... Your content goes here ... -->
                 ...
                 <div class="table-responsive">
                  ...
                  <div>
                      ...
                      <p class="d">Department Of Computer Science & Engineering</p>
                     ...
                     <div class="head1">
                      ...
                      <form action="{{url('/coursemark1')}}">
                          {{ csrf_field() }}
                      <div class="se1">
                <span style="font-size: 12px; color: red;"> @ Please Select Session & Semester for add course mark</span>
                <br>
