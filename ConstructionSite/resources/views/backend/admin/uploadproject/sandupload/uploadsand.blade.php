    ...
    <div class="row justify-content-center">
        ...
        <div class="card">
            ...
            <div class="card-body shadow-lg">
                <form enctype="multipart/form-data" action="{{ url('sand.save') }}"  method="POST" id="form-submit">
                    @csrf
                    ...
                    <div class="row form-group justify-content-center">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="category"
                             placeholder="Sand Category" required>
                    ...
                    <div class="row  justify-content-strat">
                        ...
                        <div class="col-md-6">
                            <label>Sand Image<span class="text-danger">*</span></label>
                        </div>
