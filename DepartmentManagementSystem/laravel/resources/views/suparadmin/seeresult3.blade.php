...
<div id="wrapper">
                     ...
                     <div class="head1">
                      ...
                      <p class="c">Department Of Computer Science & Engineering</p>
                         ...
                         <div class="alert alert-success" style="text-align: center;">
                             <b>This semester and session Already Approve!</b>
   ...
   <div class="table-responsive" style="text-align: center;">  
                      ...
                      <p style="font-style: oblique; color: red; font-size: 20px; text-align: center;">  Cse Students</p>
                 
                 <form action="{{url('/seeresult3')}}" method="POST">
                    {{ csrf_field() }}
                         ...
                         <select name="session" class="form-control" placeholder="Search Session..." required="" style="margin-left: 340px;width: 320px;" >
                          <option>Enter Session</option>
                           <option>{{$o->session}}</option>
                    ...
                    <select name="semester" class="form-control" required=""  style="margin-left: 340px;width: 320px;">
