...
class VoucherManagementController extends Controller
{
    ...
    public function generated_vouchers()
    {
       ...
       return view('backend.admin.voucher_management.generate_vouchers',['vouchers' => $vouchers,'generetvoucher'=>  $generet_voucher])->with('status',$status);
    }
    ...
    public function description_find(Request $request)
    {
      
      $teacher=ChartOfAccount::where('id',$request->student_id)->first();
      
      return array('description' => $teacher->description);
