...
Route :: get('view-salary/{generate_id}',[ReportManager :: class,'view_salary_sheet'])->name('view-salary-sheet')->middleware('permission:view payroll');
Route :: get('download-salary-sheet/{generate_id}',[ReportManager :: class,'download_salary_sheet'])->name('download-salary-sheet')->middleware('permission:download payroll');
Route :: get('download-bank-advice/{generate_id}',[ReportManager :: class,'download_bank_advice'])->name('download-bank-advice')->middleware('permission:download payroll');
Route :: get('trial-balance-report-start',[ReportManager :: class,'trial_balance_report_start'])->name('trial-balance-report-start')->middleware('permission:report accounts');
Route :: get('download-trial-balance-pdf',[ReportManager :: class,'trial_balance_pdf'])->name('download-trial-balance')->middleware('permission:report accounts');
Route :: get('download-balance-sheet',[ReportManager :: class,'generate_balance_sheet'])->name('download-balance-sheet')->middleware('permission:report accounts');
Route :: get('view-balance-sheet',[ReportManager :: class,'view_balance_sheet'])->name('view-balance-sheet')->middleware('permission:report accounts');
Route :: get('download-individual-pf-report',[ReportManager :: class,'individual_pf_report'])->name('download-individual-pf-report')->middleware('permission:report provident');
Route :: get('download-monthly-pf-statement',[ReportManager :: class,'providentFundReportDownload']) -> name('download-pf-monthly-statement')->middleware('permission:report provident');
Route :: get('download-yearly-pf-statement',[ReportManager :: class,'yearly_pf_statement']) -> name('download-pf-yearly-statement')->middleware('permission:report provident');
Route :: get('download-dept-wise-pf-report',[ReportManager :: class,'dept_wise_pf_report']) -> name('download-dept-wise-pf-report')->middleware('permission:report provident');
Route :: get('download-class-wise-pf-report',[ReportManager :: class,'class_wise_pf_report']) -> name('download-class-wise-pf-report')->middleware('permission:report provident');
Route :: get('individual-pf-report-start',[ReportManager :: class,'individual_pf_start'])->name('individual-pf-start')->middleware('permission:report provident');
Route :: get('yearly-pf-report-start',[ReportManager :: class,'yearly_pf_start'])->name('yearly-pf-start')->middleware('permission:report provident');
...
Route :: get('cash-book-report-start',[ReportManager :: class,'cash_book_report_start'])->name('cash-book-report-start')->middleware('permission:report accounts');
Route :: get('cash-book-download',[ReportManager :: class,'cash_book_report_download'])->name('cash-book-report-download')->middleware('permission:report accounts');
