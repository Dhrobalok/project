...
.fa
{
    ...
    <div class="col-md-4">
      ...
      <div class="card">
         <div class="card-header shadow-sm" style="width: 100%;">
            <p class="p-0 m-0 p-2 " style="text-align: center;font-size:15px;color:darkmagenta;"><strong  style="display: inline-block;">{{ $electricproduct->category }}&nbsp;Details</strong> </p>
         ...
         <div class=" card-body">
            <table class="table">
                <tbody >
                    ...
                    <tr>
                        <td>{{ $electricproduct->category }}&nbsp;View</td>
                        <td>:</td>
                        <td> <img class="p-2 zoom" src = "{{ URL :: to($electricproduct -> image) }}" id="logo" alt="Avatar" ></td>
                    </tr>
                    <tr>
                        <td>Category</td>
                        <td>:</td>
                        <td>{{ $electricproduct->category }}</td>
                    ...
                    <tr>
                        ...
                        <td>Price</td>
                        <td>:</td>
                        <td>{{ $electricproduct->price }}&nbsp;<span style="font-family: fantasy;">&#2547;</span></td>
      ...
      <div class="col-md-6">
         ...
         <div class="card">
            ...
            <div class="card-body">
                @php
                $company=App\Models\Compane::where('employe_id',$electricproduct->employee_id)->first();
               @endphp
                @php
  ...
  <div class="col-md-4 py-4">
    ...
    <div class="card">
      ...
      <div class="card-body">
          <p class="text-center">
             @php
                Mapper::map($electricproduct->lat, $electricproduct->lng);
             @endphp
               ...
               <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                      ...
                      $employeeimage=App\Models\Employee::where('id',$electricproduct->employee_id)->first();
                    ...
                    <p style="font-size: 17px;color:black;text-align:center; width:bold;">
                      @php
                        $email=App\Models\User::where('id',$electricproduct->employee_id)->first();
                      ...
                      <div class="card-header" style="height:width:25%">
                        ...
                        <form action="{{ url('savecontact') }}" method="POST">
                          ...
                          <div class="form-group py-3">
                            ...
                            <input type="hidden" name="size" value="{{ $electricproduct->iteam }}">
                            <input type="hidden" name="id" value="{{ $electricproduct->employee_id }}">
  ...
  $allBrick=App\Models\Electric::where('iteam',$iteam)->get();
 @endphp


 <h5 class="text-center text-secondary">SIMILAR {{$iteam}}</h5>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="{{URL('view.electric',$brickall->id)}}" class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <h5 class="text-secondary ">{{$brickall->iteam}}&nbsp;</h5>
