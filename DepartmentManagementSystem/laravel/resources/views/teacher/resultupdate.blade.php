                    ...
                    <div class="Banner">
                     ...
                     <div class="head1">
                        <img src="images/pust_logo.png" style="height:100px; width: 100px; margin-bottom: 45px;">                     
                         ...
                         <form action="{{url('/resultupdate2')}}" style="margin-top: 70px;">
                    {{ csrf_field() }}
  ...
  <table class="table table-hover" style="width:100%;">
    ...
    @foreach($f as $r)
      <tr>
        ...
        <td>{{$r->session}} <input type="hidden" name="session" value="{{$r->session}}"></td>
        <td>{{$r->semester}}<input type="hidden" name="semester" value="{{$r->semester}}"></td>
        <td>{{$r->roll}}<input type="hidden" name="roll" value="{{$r->roll}}"></td>
         <input type="hidden" name="course" value="{{$r->course}}">   
        <td><button class="btn btn-primary"><i class="fa fa-edit" style="font-size:12px"></i>&nbspEdit</button> </td>
