            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto" >
                        <!--class="navbar-nav ml-auto" Authentication Links -->
                       
                        
                        
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('login') }}"><span style="font-size:16px; font-weight:bold;color:aliceblue;">Login</span></a>
                                </li>
                           

                              
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('employesignup') }}"><span style="font-size:16px; font-weight:bold;color:aliceblue;">Register</span></a>
                                </li>
