...
class DebitController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.admin.vouchers.debit_vouchers.create',['employees' => $employees,'logged_employee' => $logged_employee,'banks' => $banks,'vendors' => $vendors]);
    }
    ...
    public function store(Request $request)
    {
       // return $request;
        ...
        $request -> validate([
            ...
            'select_credit_account' => ['required']
        ]);
        ...
        $debit_voucher -> voucher_no = $voucher_no;
