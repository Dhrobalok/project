...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="{{route('Profile')}}">
            Profile
        </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a  class="brand-link">
        <img src="{{ asset('images/4WYgORYERneMHCAVLl4s.png') }}" class="brand-image img-circle elevation-3" style="opacity: 1">
      <span class="brand-text font-weight-light">rajIT School</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        @endphp
        <div class="info">
          <a href="#" class="d-block">{{$user->first_name}}&nbsp;{{$user->first_name}}</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('ApproveUser')}}" class="nav-link">
