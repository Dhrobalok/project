        ...
        <div class="col-md-7">
           <div class=" card-header text-center pt-4;" style="background:#a2b9bc;">
              ...
              {{-- <div class="text-center">
                 ...
                 <h1 style="font-size:16px; font-weight:bold;; font-weight:bold" class=""></h1>
              </div> --}}
                 
           </div>
            <div class="card" style="background-color:#E5EFF9">
                
                 <div class="text-center p-4"><span style="font-weight: bold;color:cadetblue;">User Login</span></div> 
