    ...
    <div class="col-md-5" style="padding: 80px;">
        ...
        <div class="card" id="card1">
            ...
            <div class="card-header">
                <h5 style="text-align: center;">Search Architect</h5>
              <form action="{{ route('Architect.location') }}" method="POST" id="form-submit">
                    @csrf
