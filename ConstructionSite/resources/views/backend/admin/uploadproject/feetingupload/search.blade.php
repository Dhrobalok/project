    ...
    <div class="col-md-5" style="padding: 80px;">
        ...
        <div class="card" id="card1">
            ...
            <div class="card-header">
                <h5 style="text-align: center;">Search Feeting</h5>
              <form action="{{ route('feeting.location') }}" method="POST" id="form-submit">
                    @csrf
                ...
                <div class="py-2">
                    @php
                       $productiteam=App\Models\Fiting::select('productitem')->get();

                    @endphp

                <select name="productitem" id="" placeholder="productiteam" class="form-control" >
                    <option value="">Please Select Option</option>
                    @foreach ($productiteam as $allproduct)

                       <option value="{{$allproduct->productitem}}">{{$allproduct->productitem}}</option>
