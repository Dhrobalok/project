...
<div class="row justify-content-center">
       ...
       <div class="col-md-8">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                  <form action="<?php echo e(url('footerAdd')); ?>" method="POST" enctype="multipart/form-data">
                       <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\rajit_project\Reda_Construction\resources\views/backend/admin/aprove/uploadFooter.blade.php ENDPATH**/ ?>