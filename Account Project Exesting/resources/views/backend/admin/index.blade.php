                ...
                <div class="content-side">
                    <ul class="nav-main">
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="{{ route('backend.admin.index') }}">
                        ...
                        @endphp
                        <li class="nav-main-item {{ $is_accounts_tab_active == true ? 'open' : '' }}">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                                aria-expanded="false" href="#">
                            ...
                            <ul class="nav-main-submenu">
                                @can('view cost')
                                <li
                                    class="nav-main-item {{ $route_prefix == 'cost-centers' ? 'current-active-link' : ''}}">
                                ...
                                @can('view accounts')
                                <li
                                    class="nav-main-item {{ in_array($route_prefix,['category','accounts']) == true ? 'current-active-link':'' }}">
                                    <a class="nav-main-link" href="{{ route('category.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">All Categories</span>
                                        </a>
                                <li class="nav-main-item {{ in_array($route_prefix,['category','accounts']) == true ? 'current-active-link':'' }}">
                                ...
                                @can('view cheque')
                                <li
                                    class="nav-main-item {{ $route_prefix == 'cheque-book' ? 'current-active-link' : '' }}">
                                ...
                                @endcan
                                @can('view banks')
                                <li class="nav-main-item  {{ $route_prefix == 'banks' ? 'current-active-link':'' }}">
                                ...
                                <li class="nav-main-item  {{ $route_prefix == 'approver' ? 'current-active-link':'' }}">
                                ...
                                @can('view vouchers')
                                <li
                                    class="nav-main-item  {{ $route_prefix == 'approved-vouchers' ? 'current-active-link':'' }}">
                                ...
                                <li
                                    class="nav-main-item {{ $route_prefix == 'rejected-vouchers' ? 'current-active-link':'' }}">
                                ...
                                <li
                                    class="nav-main-item {{ $route_prefix == 'generated-vouchers' ? 'current-active-link':'' }}">
                                ...
                                <li
                                    class="nav-main-item {{ $route_prefix == 'bill-users' ? 'current-active-link' : ''}}">
                    ...
                    <div>
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn btn-dual" id="page-header-user-dropdown"
                                ...
                                <span class="d-none d-sm-inline-block f-100">{{ Auth :: user() -> name }}</span>
