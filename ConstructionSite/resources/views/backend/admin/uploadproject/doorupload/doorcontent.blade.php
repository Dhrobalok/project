...
#logo
{
    ...
    <div class="col-md-4">
      ...
      <div class="card">
         <div class="card-header shadow-sm" style="width: 100%;">
            <p class="p-0 m-0 p-2 " style="text-align: center;font-size:15px;color:darkmagenta;"><strong  style="display: inline-block;">Door Details</strong> </p>
         ...
         <div class=" card-body">
            <table class="table">
                <tbody class="text-center">
                    ...
                    <tr>
                        <td style="font-family: Franklin Gothic Medium;">Door View</td>

                        <td>:</td>
                        <td>
                            <img class="p-2 zoom" src = "{{ URL :: to($alldoor -> image) }}" id="logo" alt="Avatar" >
                        </td>
                    </tr>
                    <tr>
                        <td style="font-family: Franklin Gothic Medium;">Category</td>
                        <td>:</td>
                        <td>{{ $alldoor->category }}</td>


                    </tr>

                    <tr>
                        <td style="font-family: Franklin Gothic Medium;">Size:</td>
                        <td>:</td>
                        <td>{{ $alldoor->size }}</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{ $alldoor->price }}<span style="font-size: 24px;">&#2547;</span></td>
      ...
      <div class="col-md-6">
         ...
         <div class="card">
            ...
            <div class="card-body">
                @php
                $company=App\Models\Compane::where('employe_id',$alldoor->employee_id)->first();
               @endphp
               ...
               <table class="table table-borderless w-100">
                ...
                {{-- <div class="row justify-content-center">
                    ...
                    <p class="py-2" style="text-align: center;">
                        <strong style="color:darkgray;">{{ $alldoor->description }}
  ...
  <div class="col-md-4 py-4">
    ...
    <div class="card">
      ...
      <div class="card-body">
          <p class="text-center">
             @php
                Mapper::map($alldoor->lat, $alldoor->lng);
             @endphp
               ...
               <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                      ...
                      $employeeimage=App\Models\Employee::where('id',$alldoor->employee_id)->first();
                    ...
                    <p class="text-center" sty>
                        <i class="fa fa-phone" style="font-size:24px;"></i>
                        <span style="display: inline-block">01765389556</span>
                    ...
                    <p style="font-size: 17px;color:black;text-align:center; width:bold;">
                      <b>Size&nbsp;{{ $alldoor->size }}&nbsp;In {{ $alldoor->address }}</b>
                    ...
                    <p style="font-size: 17px;color:black;text-align:center; width:bold;">
                      @php
                        $email=App\Models\User::where('id',$alldoor->employee_id)->first();
                      ...
                      <div class="card-header" style="height:width:25%">
                        ...
                        <form action="{{ url('savecontact') }}" method="POST">
                          ...
                          <div class="form-group py-3">
                            ...
                            <input type="hidden" name="size" value="{{ $alldoor->size }}">
                            <input type="hidden" name="id" value="{{ $alldoor->id }}">
  ...
  $allBrick=App\Models\Door::get();
 @endphp


 <h5 class="text-center text-secondary">SIMILAR DOOR</h5>
      ...
      <div class="card-body shadow p-8">
         <div class="owl-carousel owl-theme">
             ...
             <div class="item">
                     ...
                     {{-- <a href="{{URL('door/view',$brickall->id)}}" class="text-center">
                             ...
                             <table class="table table-borderless w-100">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-family: Franklin Gothic Medium;">
                                            <h5 class="text-secondary ">{{$brickall->size}}&nbsp;mm&nbsp;Door</h5>
                                        </td>
                                     ...
                                     <tr>
                                         <td style="font-family: Franklin Gothic Medium;">Price</td>
                                        <td>:</td>
                                        <td>{{$brickall->price}}&nbsp;<span style="font-size: 24px;">&#2547;</span>
                                         </td>
                                     ...
                                     <tr>
                                         <td style="font-family: Franklin Gothic Medium;">Door&nbsp;Size</td>
                                         <td>:</td>
                                         <td>{{$brickall->size}}&nbsp;mm</td>
                                     </tr>
                                 </tbody>
