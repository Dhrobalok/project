...
#logo
{
    ...
    <div class="col-md-4">
      ...
      <div class="card">
         <div class="card-header shadow-sm" style="width: 100%;">
            <p class="p-0 m-0 p-2 " style="text-align: center;font-size:15px;color:darkmagenta;"><strong  style="display: inline-block;">Sand Details</strong> </p>
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-family:Franklin Gothic Medium;">Sand&nbsp;View</td>
                        <td>:</td>
                        <td> <img class="p-2 zoom" src = "{{ URL :: to($allsand -> image) }}" id="logo" alt="Avatar" ></td>
                    </tr>
                    <tr>
                        <td style="font-family:Franklin Gothic Medium;">Category</td>
                        <td>:</td>
                        <td>{{ $allsand->category }}</td>
      ...
      <div class="col-md-6">
         ...
         <div class="card">
            ...
            <div class="card-body">
                @php
                $company=App\Models\Compane::where('employe_id',$allsand->employee_id)->first();
               @endphp
              ...
              <table class="table table-borderless w-100">
                ...
                {{-- <div class="row justify-content-center">
                    ...
                    <p class="py-2" style="text-align: center;">
                        <strong style="color:#487b7b;">Address:
                    ...
                    <p class="py-2" style="text-align: center;">
                        <strong style="color:#487b7b;">{{ $company->address }}
  ...
  <div class="col-md-4 py-4">
    ...
    <div class="card">
      ...
      <div class="card-body">
          <p class="text-center">
             @php
                Mapper::map($allsand->lat, $allsand->lng);
             @endphp
               ...
               <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                      ...
                      $employeeimage=App\Models\Employee::where('id',$allsand->employee_id)->first();
                    ...
                    <p style="font-size: 17px;color:black;text-align:center; width:bold;">
                      <b>Category&nbsp;{{ $allsand->category }}&nbsp;In {{ $allsand->address }}</b>
                    ...
                    <p style="font-size: 17px;color:black;text-align:center; width:bold;">
                      @php
                        $email=App\Models\User::where('id',$allsand->employee_id)->first();
                      ...
                      <div class="card-header" style="height:width:25%">
                        ...
                        <form action="{{ url('savecontact') }}" method="POST">
                          ...
                          <div class="form-group py-3">
                            ...
                            <input type="hidden" name="size" value="{{ $allsand->category }}">
                            <input type="hidden" name="id" value="{{ $allsand->employee_id }}">
  ...
  $allsand=App\Models\Sand::get();
 @endphp


 <h5 class="text-center text-secondary">SIMILAR SAND</h5>
                         ...
                         <div class="col-md-5 py-2">
                             ...
                             <table class="table">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{URL('sanitary/view',$sandall->id)}}" class="text-center">
                                                <img src="{{ URL :: to($sandall -> image) }}" alt="" style="max-width: 100%;height:auto;">
                                             </a>
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-secondary ">{{$sandall->category}}&nbsp; Sand</h5>

                                        </td>
                                    </tr>

                                     {{-- <tr>
                                         <p>{{$sandall->description}}</p>
                                     </tr> --}}
