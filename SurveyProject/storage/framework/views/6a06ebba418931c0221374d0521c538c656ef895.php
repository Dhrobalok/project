   ...
   <!--  Second column  -->
    ...
    <div class="col-md-8">
       ...
       <div class="row" id="search_content">
          ...
          <?php $__currentLoopData = $allitem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allitems): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

        <div class="col-md-3  mt-5" >
            <a href="<?php echo e(url('view.question',$allitems->id)); ?>" style="text-decoration: none; color:#68696a;">
                <div  class="card shadow" id="card" style="background-color:rgb(234, 225, 225);width:100%;height: 100%; object-fit: cover; ">



                    <p class="text-center p-1 mt-1" style="font-weight:500;color:#000;font-size:1.2vw;padding: 10px"><?php echo e($allitems->name); ?></p>
                    ...
                    ?>
                    <p class="text-center" style="font-size: 14px;"><span style="font-size: 14px;"><?php echo e($totalquestion); ?></span> question</p>
         ...
         <?php
          ...
          <?php $__currentLoopData = $allitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

          <div class="col-md-3  mt-5">
              <a href="<?php echo e(url('copy.question',$items->item_id)); ?>" style="text-decoration: none; color:#2c3e50;">
                  <div  class="card shadow" id="card" style="background-color:white;width:100%;height: 100%; object-fit: cover;  ">
                    ...
                    ?>
                      ...
                      <p class="text-center p-1 mt-1" style="font-weight: bold;color:#785454;font-size:1.2vw;"><?php echo e($ItemName->name); ?></p>
                        ...
                        <form id="decline_confirm" class="mt-3">
                            ...
                            <div class="col-md-12 p-3">
                                    ...
                                    <select name="iteam_id"  class="form-control">
                                        ...
                                        <?php $__currentLoopData = $allitem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allitems): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($allitems->id); ?>"><?php echo e($allitems->name); ?></option>
...
<script>
    $('#decline_confirm2').on('submit',function(e){
        ...
        $.ajax({
            url : "<?php echo e(url('Iteam.create')); ?>",
            type : "post",
...
<?php echo $__env->make('backend.Dashboard.servey', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\rajit_project\IBSC_SERVEY\resources\views/backend/Servay/create.blade.php ENDPATH**/ ?>