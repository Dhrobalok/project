    ...
    <div class="row justify-content-center">
        ...
        <div class="card">
            ...
            <div class="card-body shadow-lg">
                <form enctype="multipart/form-data" action="{{ route('tile.save') }}"  method="POST" id="form-submit">
                    @csrf
                    ...
                    <div class="row  justify-content-start">
                        ...
                        <div class="col-md-6">
                            <label>Tiles Category</label><span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row  justify-content-strat">
                        ...
                        <div class="col-md-6">
                            <label>Tiles Image<span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row  justify-content-start">
                        ...
                        <div class="col-md-6">
                            <label>Tiles Size</label><span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row  justify-content-start">
                        ...
                        <div class="col-md-6">
                            <label>Tiles Price</label><span class="text-danger">*</span></label>
                        </div>
