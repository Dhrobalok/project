        ...
        <div class="col-md-7">
           <div class="text-center">
              ...
              <div class="text-center">
                 ...
                 <h1 style="font-size:16px; font-weight:bold" class="">RU Contact</h1>
              </div>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="email" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Photo')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\rajit_project\Ru_emergency_contact\resources\views/frontend/employee-signup.blade.php ENDPATH**/ ?>