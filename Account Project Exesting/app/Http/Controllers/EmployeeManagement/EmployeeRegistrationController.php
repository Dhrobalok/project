...
class EmployeeRegistrationController extends Controller
{
    public function register()
    {
        ...
        */
        ...
        return view('frontend.employee-signup',$data);
    ...
    public function saveOldEmployee(Request $request)
    {
       ...
       // return "saveoldemployee";
        ...
        $user -> email = $email;
        $user -> status = 0;
        $user->id=$request -> employee_number;
      ...
      /*
        ...
        */
        ...
        $emergency_contact->employee_id=$userid;
       ...
       // $this -> savePreviousWorkingExperienceDetails($request,$employee);
        ...
        return redirect() -> route('admin.employee-management.employees.index')->with('success-message','New employee added successfully');
    }
