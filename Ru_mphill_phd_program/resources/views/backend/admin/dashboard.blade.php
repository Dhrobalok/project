    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="alert alert-light alert-dismissible fade show shadom-lg" role="alert">
                <div class="row">
                    <div class="col-md-8">
                        <div class="f-roboto text-green"><img src="{{ asset('public/company_pic/ru-logo.png') }}" alt=""><p style="display:inline-block;font-size:16px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Welcome To Institute Of Biological Sciences,University&nbspof&nbspRajshahi</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                     ...
                     {{--  <div class="row">
                        <div class="col-md-4 text-center">
                            <label class="f-roboto text-black">{{ $voucher_pendings + $total }}</label>
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-4 text-center">
                            <a class="btn-custom" href="{{ route('admin.approve.index') }}">View All</a>
                        </div>
                        {{--  
                        <div class="col-md-4 text-center">
                            <a class="btn-custom" href="{{ route('admin.bill-users.index') }}">View All</a>
                        </div>
                        <div class="col-md-4 text-center">
                            <a class="btn-custom" href="{{ route('admin.pf-loan.pending-loans') }}">View All</a>
                        </div>
                        -
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 text-center">
                            ...
                            <label class="f-roboto text-black">{{ Session::get('rr') + Session::get('pf') }}</label>
                        </div>


                        <div class="col-md-4 text-center">

                            <label class="f-roboto text-black">{{ Session::get('ad_voucher') }}</label>
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-4 text-center">
                            ...
                            <button type="button" id="formButton" class="btn-custom">view all</button>
                             ...
                             <form id="form1">
                                @if( Session::get('rr')!=0 || Session::get('pf')!=0 )
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1"></label>
                                                    ...
                                                    <ul class="list-group">
                                                     ...
                                                     @foreach($key as $fdr_Number=>$fdr_value)
                                                        <li class="list-group-item">


                                                       <span style="line-height: 33px;">FDR {{ $fdr_Number}} for mature {{ $fdr_value }}  days left</span>
                                                     ...
                                                     @foreach($pkey as $pfdr_Number=>$pfdr_value)
                                                     <li class="list-group-item">


                                                    <span style="line-height: 33px;">PFFDR {{ $pfdr_Number}} for mature {{ $pfdr_value }}  days left</span>
                             ...
                             <div class="col-md-4 text-center">
                                <a class="btn-custom" href="{{ route('notuploadvoucher') }}">View All</a>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            <img src="{{ URL :: to('employee_images/employee-logo.png') }}" class="rounded-circle">
                        </div>

                        <div class="col-md-3 text-center">
                            <img src="{{ URL :: to('employee_images/budget-icon.png') }}" class="rounded-circle">
                        </div>
                        <div class="col-md-3 text-center">
                            <img src="{{ URL :: to('employee_images/house-loan.png') }}" class="rounded-circle">
                        </div>
                        --}}
                        ...
                        <div class="col-md-3 text-center">
                            <img src="{{ URL :: to('employee_images/accounts-logo.png') }}" class="rounded-circle">
                        </div>
                    ...
                    <div class="row">
                        {{--  
                              ...
                              <div class="col-md-3 text-center">
                            <a href="{{  route('admin.employee-management.employees.index') }}">Employees</a>
                        </div>
                       ...
                       --}}
                        ...
                        <div class="col-md-3 text-center">
                            <a href="{{ route('admin.approve.index') }}">Pending Voucher</a>
                        </div>

                        <div class="col-md-3 text-center">
                            <a href="{{ route('accounts.index') }}">Chart Of Accounts</a>
                        </div>
                    ...
                    <div class="card-body bg-white">
                        <form id="company_settings">
                           <div class="row text-center">
                                <div class="col-md-12">
                                    <img src="{{ URL :: to('employee_images/default-logo.png') }}" height="150px"
...
$('#company_settings').submit(function(e) {
    ...
    $.ajax({
        url: "{{ route('admin.company-profile.store') }}",
        type: "POST",
        data: CompanySetup,
        contentType: false,
        processData: false,
