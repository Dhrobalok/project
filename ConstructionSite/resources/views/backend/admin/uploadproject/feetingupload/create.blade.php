    ...
    <div class="row justify-content-center">
        ...
        <div class="card">
            ...
            <div class="card-body shadow-lg">
                <form enctype="multipart/form-data" action="{{ url('feeting.save') }}"  method="POST" id="form-submit">
                    @csrf
                    ...
                    <div class="row  justify-content-strat">
                        ...
                        <div class="col-md-6">
                            <label>Feeting Image<span class="text-danger">*</span></label>
                        </div>
