        ...
        <nav id="sidebar" aria-label="Main Navigation">
                ...
                <div class="content-header bg-white-10">
                    ...
                    <a class="font-w600 text-white tracking-wide" href="index.html">
                        ...
                        <span class="smini-hidden">
                            <img class="img2" src="{{ asset('images/excavator-construction-logo-with-buildings_23-2148657768.webp') }}" alt=""> Construction Site
                        </span>
                    </a>
                    <!-- END Logo -->
            ...
            <div class="js-sidebar-scroll ">
                ...
                <div class="content-side">
                    <ul class="nav-main">
                        <li class="nav-main-item">
                         ...
                         @endphp
                            ...
                            <li class="nav-main-item ">
                                <a class="nav-main-link" href="{{ route('yearly.renewal') }}">
                                    <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                            ...
                            <li class="nav-main-item ">
                                <a class="nav-main-link" href="{{ url('Advertise') }}">
                                    <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                            ...
                            <li class="nav-main-item ">
                                <a class="nav-main-link" href="{{ route('Logolist') }}">
                                    <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                            ...
                            <li class="nav-main-item ">
                                <a class="nav-main-link" href="{{ route('footerLink') }}">
                                    <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                            ...
                            {{-- <li class="nav-main-item ">
                                <a class="nav-main-link" href="{{ url('Vedio.Upload') }}">
                                    <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                                    <span class="nav-main-link-name">Upload&nbsp;Vedio</span>
                                </a>
                            </li> --}}
                      ...
                      @else
                       ...
                       @if($companystatus=='Apartment')
                           ...
                           <li class="nav-main-item ">
                            <a class="nav-main-link" href="{{ route('upload.project') }}">
                                <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                        ...
                        <li class="nav-main-item ">
                         <a class="nav-main-link" href="{{ url('land.upload') }}">
                             <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                      ...
                      @elseif($companystatus=='Ploat')

                      <li class="nav-main-item ">
                       <a class="nav-main-link" href="{{ route('upload.ploat') }}">
                           <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                    ...
                    <li class="nav-main-item">
                     <a class="nav-main-link" href="{{ url('brick') }}">
                         <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                  ...
                  @elseif($companystatus=='Cement')
                   ...
                   <li class="nav-main-item ">
                      <a class="nav-main-link" href="{{ route('upload.cement') }}">
                       <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                  ...
                  @elseif($companystatus=='Steel')
                    ...
                    <li class="nav-main-item ">
                        <a class="nav-main-link" href="{{ url('steels.upload') }}">
                           <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                 ...
                 @elseif($companystatus=='Tiles')
                     ...
                     <li class="nav-main-item ">
                         <a class="nav-main-link" href="{{ url('upload.tiles') }}">
                         <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                   ...
                   @elseif($companystatus=='Door')
                     ...
                     <li class="nav-main-item ">
                          <a class="nav-main-link" href="{{ route('upload.door') }}">
                          <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                  ...
                  @elseif($companystatus=='Sanitary')
                     ...
                     <li class="nav-main-item ">
                        <a class="nav-main-link" href="{{ url('upload.sanitary') }}">
                         <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                   ...
                   @elseif($companystatus=='Feetings')
                       ...
                       <li class="nav-main-item ">
                           <a class="nav-main-link" href="{{ url('upload.feetings') }}">
                           <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                  ...
                  @elseif($companystatus=='Sand')
                     ...
                     <li class="nav-main-item ">
                         <a class="nav-main-link" href="{{ route('sand.Index') }}">
                        <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                 ...
                 @elseif($companystatus=='Hardware')
                      ...
                      <li class="nav-main-item ">
                           <a class="nav-main-link" href="{{ url('upload.hardware') }}">
                           <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                 ...
                 @elseif($companystatus=='Architect')
                      ...
                      <li class="nav-main-item ">
                             <a class="nav-main-link" href="{{ url('upload.architect') }}">
                             <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                     ...
                     <li class="nav-main-item ">
                         <a class="nav-main-link" href="{{ url('upload.interior') }}">
                        <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                 ...
                 @elseif($companystatus=='Electric')
                      ...
                      <li class="nav-main-item ">
                           <a class="nav-main-link" href="{{ url('upload.electric') }}">
                           <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                           <span class="nav-main-link-name">Electric Upload</span>
                          </a>
                      </li>
                 @elseif($companystatus=='Plot')

                      <li class="nav-main-item ">
                             <a class="nav-main-link" href="{{ route('upload.plot') }}">
                             <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
                     ...
                     <li class="nav-main-item ">
                            <a class="nav-main-link" href="{{ route('upload.paint') }}">
                            <i class="nav-main-link-icon fas fa-tachometer-alt"></i>
            ...
            <div class="content py-0">
                <div class="row font-size-sm">
                    ...
                    <div class="col-sm-6 order-sm-1 text-center text-sm-left">
                        <img class="img2" src="{{ asset('images/excavator-construction-logo-with-buildings_23-2148657768.webp') }}" alt="">Construction Site &copy;<span
