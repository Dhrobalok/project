...
<div class="container-fluid pl-0 pr-0 ml-0 mr-0 mb-4">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form id="vendor_info" action="{{ route('admin.sales.vendors.update',['vendor_id' => $vendor -> id]) }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="f-roboto mb-4">Vendor Information</div>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <input type="file" id="file_upload_photo" hidden name="vendor_photo">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 pr-0">
                                <input type="text" class="form-control" placeholder="Company Name / Individual Name"
                                    name="vendor_name" value="{{ $vendor -> name }}" required>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" name="mobile_number"
                                    value="{{ $vendor -> mobile_number }}" required>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-1">
                            ...
                            <div class="col-md-5 pr-0">
                                <select class="form-control" name="country">
                                    <option value="{{ $vendor -> country }}" selected hidden>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" name="account_receivable">
                                            ...
                                            @if($vendor -> account_receivable == $account -> id)
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <textarea class="form-control"
                                            placeholder="Write some notes about that vendor"
                                            name="internal_notes">{{ $vendor -> note }}</textarea>
                                    </div>
                                </div>
...
$('form').submit(function(e) {
    ...
    if (form.id != 'vendor_info') {
        ...
        $.ajax({
            url: "{{ route('admin.sales.vendor.contacts.save') }}",
            type: "post",
            data: contactsData,
            processData: false,
            contentType: false,
        ...
        //vendor data must be sent in same procedure
    }
...
function add_a_line() {
    ...
    $.ajax({
        url: "{{ route('admin.sales.vendor.bank-account.add') }}",
        type: "get",
        success: function(res) {
...
$(document).ready(function() {
    $('#vendor_photo').on('click', function(e) {
        $('#file_upload_photo').trigger('click');
    });
    $(document).on("change", "#file_upload_photo", function() {

        var vendor_photo = $('#file_upload_photo').prop('files')[0];
        var reader = new FileReader();
        reader.onload = function() {
            $("#vendor_photo").attr("src", reader.result);
        }
        reader.readAsDataURL(vendor_photo);
    });
});
