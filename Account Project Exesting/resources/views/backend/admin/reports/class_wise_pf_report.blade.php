...
<body>
    <div class="container">
        ...
        <div class="heading">
            <p><b>EMPLOYEE PROVIDENT FUND SCHEME - Class Wise Report </b></p>
        </div>
   ...
   @foreach($employee_class as $class)
       
        <div class="heading">
          <p style = "text-align:left;"><b>{{ $class -> name }}</b></p>
        </div>
        @php $employees = $class -> employees; @endphp
