...
<div id="wrapper">
   ...
   <div class="table-responsive">  
                ...
                <table class="table table-bordered" id="dynamic_field">  
                 <form action="{{url('/seestudent')}}">
                    {{ csrf_field() }}

                          <div class="navbar-default sidebar" role="navigation" style="position: absolute;top:65px; margin-top: 228px; margin-left: 376px;">
                          <div class="sidebar-nav navbar-collapse">
              ...
              <tr>
                ...
                <td>{{$t->name}}</td>
                 ...
                 <td>{{$t->mobile}}</td>
                   <td>{{$t->roll}}</td>
                     <td> <img src="{{ asset('uploads/pic/' . $t->image) }}" style="height: 45px;width: 45px;"></td>
