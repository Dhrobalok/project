         ...
         <div class="Banner">
             ...
             <div class="col-lg-12">
               @if(Session::has("alert"))
                   ...
                   <p style="text-align: center; font-style: oblique; font-size: 20px;"> @ Teacher Guard @ </p>     

<form action="{{url('/guard')}}">
 @csrf
...
<tr>
      ...
      <td>
        <select name="name" class="form-control" style="height: 40px; width: 142px;">
          @foreach($r as $t)
        ...
        <input type="date" name="date" class="form-control" style="height: 40px; width: 140px;">
        </td>
