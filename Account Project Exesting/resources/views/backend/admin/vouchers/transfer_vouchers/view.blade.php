    ...
    <div class="block-content block-content-full">
            ...
            <div class="card-header bg-white">
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <a class="mr-2" href="{{ route('admin.voucher.transfer.edit',['id' => $voucher -> id]) }}"
                            style="color:blue;font-weight:500;font-size:22px"><i class="fa fa-pencil-alt mr-2"></i>Edit</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-header f-roboto">
                <div class="row">
                    <div class="col-md-12">
                        <strong>Transfer Voucher</strong>
                    </div>
