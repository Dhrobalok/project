...
<div class="row justify-content-center">
    ...
    <div class="col-md-5" style="padding: 60px;">

        <div class="card " id="card1">

            <div class="card-body shadow">
                <h5 style="text-align: center;">Search Brick</h5>
              <form action="{{ route('brick.location') }}" method="POST" id="form-submit">
                    @csrf
                  ...
                  {{-- <div class="py-2">
                   ...
                   {{-- @php
                       $size=App\Models\Brick::max('bricksize');
                       $price=App\Models\Brick::max('price');
                   @endphp --}}

                  {{-- <div class="form-group">
                        <label for="formControlRange">Enter Size Range</label>
                        <input type="range" name="size" class="form-control-range" max="{{$size}}" min="0" id="formControlRange" onInput="$('#rangeval').html($(this).val())">
                        <span id="rangeval">{{floor($size/2)}}<!-- Default value --></span>
                  </div> --}}


                  {{-- <div class="form-group">
                    <label for="formControlRange">Enter Price Range</label>
                    <input type="range" name="price" class="form-control-range" max="{{$price}}" min="0" id="formControlRange" onInput="$('#rangeval2').html($(this).val())">
                    <span id="rangeval2">{{floor($price/2)}}<!-- Default value --></span>
                 </div> --}}
