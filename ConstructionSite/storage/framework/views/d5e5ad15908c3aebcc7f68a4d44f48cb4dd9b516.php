                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link text-center p-2" href="#" data-bs-toggle="dropdown"><button class="btn btn-alt primary"><span style="color: white">Electric</span></button></a>
                                 <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="<?php echo e(url('see.electric',$productall->iteam)); ?>" style="color: #125d9b;">

                                            <?php echo e($productall->iteam); ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                                ...
                                                <li style="font-size:14px;"><a class="dropdown-item" href="<?php echo e(url('about.hardware',$productall->productitem)); ?>" style="color: #125d9b;">  <?php echo e($productall->productitem); ?></a></li>
			...
			<div class="row justify-content-start">
				<div class="col-md-5" style="padding: 80px;">
					...
					<div class="card" id="card1">
						...
						<div class="card-header">
						  ...
						  <form action="<?php echo e(url('location2')); ?>" method="POST" id="form-submit">
								<?php echo csrf_field(); ?>
				...
				<div class="col-md-5" style="padding: 80px;">
					...
					<div class="card" id="card2">
						<div class="card-header">
						 <form action="<?php echo e(route('Land.found')); ?>" method="POST" id="form-submit2" validate>
							<?php echo csrf_field(); ?>
...
<script>
	$(document).ready(function (){
		...
		$.ajax({
			url : "<?php echo e(route('Aptlocation.find')); ?>",
			type : "get",
...
<script>
	$(document).ready(function (){
		...
		$(document).on('change', '#ploat', function(){
			...
			const addreess = $(this).val();
		$.ajax({
			url : "<?php echo e(route('Ploatlocation.find')); ?>",
			type : "get",
			data : { addreess : addreess },
			dataType:'json',
			success:function(res)
...
<?php /**PATH D:\laragon\www\rajit_project\Reda_Construction\resources\views/backend/admin/userdashboard/dashboarduser.blade.php ENDPATH**/ ?>