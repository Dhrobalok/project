...
class EmployeeRegistrationController extends Controller
{
    ...
    public function saveOldEmployee(Request $request)
    {
       ...
       // return "saveoldemployee";
        ...
        $adress=$request->officeaddress;


       $image = $request -> file('employee_photo');
       $image2 = $request -> file('payslip');
       $profile_photo_path = '';
       ...
       if($image2)
       {
        ...
        $employee->payslip=$profile_photo_path2;


        $employee->employee_photo=$profile_photo_path1;
      ...
      if($employee->save())
      {
        ...
        $company->employe_id=$employee->id;
        ...
        if($logo)
        {
          ...
          $profile_photo_path3 = $image_url;

        }

        $company->logo=$profile_photo_path3;
