  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo e(route('AdminDas')); ?>" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="<?php echo e(route('Profile')); ?>">
            Profile
        </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        ?>
        <div class="info">
          <a href="#" class="d-block"><?php echo e($user->firstname); ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="<?php echo e(route('AdminDas')); ?>" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('ApproveUser')); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('See.survey')); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url('Teacher.List')); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('stduentList')); ?>" class="nav-link">
              <i class="nav-icon fas fa-table"></i>
              <p>
                All&nbsp;Student
                <i class="fas fa-angle-left right"></i>
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('Teacher&Student')); ?>" class="nav-link">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Teacher&nbsp;&&nbsp;Student
                <i class="fas fa-angle-left right"></i>
...
<script>
    $('#decline_confirm').on('submit',function(e){
        ...
        $.ajax({
            ...
            url : "<?php echo e(url('Teacher.create')); ?>",
            type : "post",
...
<?php /**PATH D:\laragon\www\rajit_project\IBSC_SERVEY\resources\views/backend/Dashboard/Master.blade.php ENDPATH**/ ?>