...
<body>
       ...
       <header id="head1">
            ...
            <div class="row justify-content-start">
                ...
                <div class="col-md-1">
                    <img src="<?php echo e(asset('images/download.png')); ?>" class="logo-navbar" alt="Responsive image" >
                        ...
                        <button type="button" class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
                          ...
                          <div class="collapse navbar-collapse" id="navbarCollapse">
                               ...
                               <div class="navbar-nav gap-5" id="nvabr">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="<?php echo e(url('ibsc')); ?>">
                                        <span>Home</span>
                                        </a>
                                  </li>
                                  ...
                                  <li class="nav-item ">
                                    <a class="nav-link" href="<?php echo e(route('activities')); ?>" ><span>About</span></a>
                                  </li>
                               ...
                               <div class="navbar-nav" id="nvabr2">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link" href="<?php echo e(route('registration')); ?>">
            ...
            <div  id="head3">
                ...
                <img src="<?php echo e(asset('images/Covid-Homepage-background-scaled.webp')); ?>" id="virus"  alt="Responsive image" >
                                         ...
                                         <table class="table table-borderless">
                                            <tr>
                                                <td>
                                                    ...
                                                    <img src="<?php echo e(asset('images/virus-4937553_1280.jpg')); ?>" style="border-radius: 50%;height:50px;width:50px; " alt="Responsive image" >
                                                </td>
                                                <td></td>
                                            ...
                                            <tr class="mt-4">
                                                <td>
                                                    ...
                                                    <img src="<?php echo e(asset('images/biofuelicons.jpg')); ?>" style="border-radius: 50%;height:50px;width:50px; " alt="Responsive image" >
                                                </td>
                                                <td></td>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <img src="<?php echo e(asset('images/cardiovascularicons.jpg')); ?>" style="border-radius: 50%;height:50px;width:50px; " alt="Responsive image" >
                                                </td>
                                                <td></td>
                  ...
                  <div class="col-md-5">
                      <div>
                          <div class="p-2">
                            ...
                            <table class="table table-borderless">
                               <?php $__currentLoopData = $SurveyInform; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $survey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              ...
                              <tr>
                                <td style="font-size: 12px;font-weight:bold;color:rgb(100, 100, 88);text-align:left;"><?php echo e($surveyName->name); ?></td>
                                <td></td>
                                <td style="font-size: 12px;font-weight:bold;color:rgb(100, 100, 88);text-align:left;"><?php echo e($surveyName->created_at->format('D M Y')); ?></td>
                               </tr>
...
<?php /**PATH D:\laragon\www\rajit_project\IBSC_SERVEY\resources\views/backend/Servay/landingPage.blade.php ENDPATH**/ ?>