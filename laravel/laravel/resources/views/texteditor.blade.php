...
<head>
    ...
    <title>Student Management System Of CSE</title>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                              ...
                              <li>
                                <a href="{{URL::to('/classroutine')}}">Seat Plane </a>
                            </li>
...
<br><br>
	 ...
	 <marquee>Advise Notice Will Be Upload Here </marquee>
  <form action="{{url('/text')}}" method="post">
    @csrf
  
<div class="wrapper">
 
  <label for="file" /><b>Title Add</b></label>
