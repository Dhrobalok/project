    ...
    <div class="col-md-5" style="padding: 80px;">
        ...
        <div class="card" id="card1">
            ...
            <div class="card-header">
              ...
              <form action="{{ route('sanitary.location') }}" method="POST" id="form-submit">
                    @csrf
                ...
                <div class="py-2">
                    ...
                    @endphp
                    @foreach ($allsanitary as $sanitary)
                        <select name="productitem" id="" class="form-control">
                            <option value="">Select Product Iteam</option>
                            <option value="{{ $sanitary->productitem }}">{{ $sanitary->productitem }}</option>
                        </select>
                    @endforeach
