...
<body>
    ...
    <div class="container">
        <h3 style="text-align:center"><img src="{{ asset('public/company_pic/ru-logo.png') }}" height="50px"
                width="50px">Institute Of Biological Science</h3>
        <h4 style="text-align:center;line-height:5px;">Institute Of Biological Science</h4>
