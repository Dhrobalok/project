<script src="<?php echo e(asset('assets/js/dashmix.core.min.js')); ?>"></script>
    <?php echo $__env->yieldPushContent('js'); ?>
    <script src="<?php echo e(asset('assets/js/dashmix.app.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/plugins/chart.js/Chart.bundle.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/js/plugins/select2/js/select2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/plugins/dropzone/dist/min/dropzone.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/plugins/es6-promise/es6-promise.auto.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/plugins/sweetalert2/sweetalert2.min.js')); ?>"></script>

    <script src="<?php echo e(asset('assets/js/pages/be_comp_dialogs.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/plugins/flatpickr/flatpickr.min.js')); ?>"></script>
    <script src = "<?php echo e(asset('assets/js/tabledit.min.js')); ?>"></script>
    <script src = "<?php echo e(asset('assets/js/plugins/bootstrap-notify/bootstrap-notify.min.js')); ?>"></script>
    <script src = "<?php echo e(asset('assets/js/plugins/canvasjs.min.js')); ?>"></script>
    <script src = "<?php echo e(asset('js/ajax_crud_table_module.js')); ?>"></script>
...
<?php /**PATH D:\laragon\www\rajit_project\IBSC_SERVEY\resources\views/backend/header-footer-files/js_files.blade.php ENDPATH**/ ?>