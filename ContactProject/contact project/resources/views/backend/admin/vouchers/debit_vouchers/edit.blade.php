...
<div class="container-fluid">
    <div class="card mb-2">
        <div class="card-header bg-white">
            <div class="row">
                <div class="col-md-6">
                    <a class="mr-4" href="{{ route('admin.voucher.debit.index') }}"
                        style="color:blue;font-weight:500;font-size:22px"><i
                            class="fa fa-arrow-circle-left mr-2"></i>Back</a>
                </div>
                <div class="col-md-6 text-right">
                    <a class="mr-2" href="{{ route('admin.voucher.debit.view',['id' => $voucher -> id]) }}"
    ...
    <div class="card" id="create-tab">
        <div class="card-header bg-light">
            <div class="row">
                <div class="col-md-8">
                    <strong class="f-roboto mt-3">Debit Voucher</strong>
                </div>
        ...
        <div class="card-body">
            <form id="debit_voucher_form">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        <select class="form-control" id="cheque_number" name="cheque_number">
                            <option value="{{ $voucher -> cheque_no }}">
                                {{ $voucher -> cheque ? $voucher -> cheque -> page_number : '' }}</option>
                        </select>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-5 form-group">
                        <select class="form-control" id="select_credit_account" name="select_credit_account">
                            <option value="{{ $voucher -> transaction_coa_account }}" selected>
                                {{ $voucher -> transaction_account -> name }}</option>
                        </select>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-3">
                        <button type="submit" class="btn btn-block f-100" style="background-color:blue;color:white">Save
                            Changes</button>
                    </div>
                </div>
            </form>
...
$(document).ready(function() {
    ...
    $('#debit_voucher_form').submit(function(e) {
        ...
        if (confirm('Are you sure to post that voucher?')) {
            ...
            $.ajax({
                url: "{{ route('admin.voucher.debit.update',['id' => $voucher -> id]) }}",
                type: "post",
                data: voucherData,
                processData: false,
                contentType: false,
