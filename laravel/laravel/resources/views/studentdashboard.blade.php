...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <ul class="nav navbar-nav navbar-left navbar-top-links">
            <li><a href="#"><i class="fa fa-home fa-fw"></i>CSE,PUST</a></li>
        </ul>
        ...
        <ul class="nav navbar-right navbar-top-links" style="float: right;">
            ...
            <li class="dropdown navbar-inverse">
                ...
                <ul class="dropdown-menu dropdown-alerts">
                    ...
                    <li>
                         ...
                         # Session&nbsp{{$c->session}}->Semester&nbsp{{$c->semester}}->
                         Result Published (Regular)
                         @endforeach
                         <br><br>
                            
                       @foreach($y as $j)

                         # Session&nbsp{{$j->session}}->Semester&nbsp{{$j->semester}}-> Improve Approve Now Can Download Admitcard 
                         @endforeach
                         <br><br><br>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li class="divider"></li>
                    <li><a href="{{URL::to('/studentlogout')}}"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                    </li>
                </ul>
            </li>
        </ul>
        ...
        <div class="navbar-default sidebar" role="navigation" class="row">
            <div class="sidebar-nav navbar-collapse"class="col-lg-10">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-sitemap fa-fw"></i> <b style="max-height: 500px;font-size: 15px;">AdmitCardIssue</b><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{URL::to('#')}}">
                                  <b style="max-height: 500px;font-size: 15px;">AdmitCard </b></a>
                            </li>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="center" style="margin-left: 220px;">
                     <marquee style="font-size: 18px; font-style: oblique;" behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();" width="800px;">
           <?php
          foreach($z as $u)
...
?>
           ...
           echo $u->session; echo"&nbsp"; echo"&nbsp"; echo $u->semester;echo"&nbsp";echo"semester";echo"&nbsp"; echo"&nbsp"; echo $u->title; echo"&nbsp"; echo"&nbsp";echo $u->examdate;echo"&nbsp"; echo"&nbsp";
                 echo "Only " .$x."&nbsp Days Remain";
...
?>
    ...
    <div class="general">
            ...
            <h4>Total Register Student </h4>   
    
           
           <div class="loader" style="text-align: center; margin-left: 45px;">
  ...
  <div class="row" style="position: absolute;top:32px;margin-left: 350px; ">
  <div class="column">
    <div class="card" >
      <a href="https://www.facebook.com/groups/228524897205268/"><img src="download.jpg" alt="Smiley face" height="250" width="450"></a>

    
    </div>
     <marquee>Join with Our Facebook group</marquee>
  </div>
