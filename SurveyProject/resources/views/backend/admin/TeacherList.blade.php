        ...
        <table class="table table-hover mt-2"  id="myTable">
            ...
            <tbody>
               ...
               <tr>
                   ...
                   <td class="text-center">{{$studentall->name}}</td>

                   <td class="text-center">

                    <a id="ProfileEdit" value={{$studentall->id}} style="font-size:12px; color:aliceblue;" class="btn btn-sm btn-primary py-1"><i class="fas fa-edit" aria-hidden="true">&nbsp;<span style="font-size:13px;">Edit</span></i></a>

                    <a  href="{{ url('delete.teacher',$studentall->id) }}" style="font-size:12px;" class="btn btn-sm btn-danger py-1" onclick="return confirm('Are you sure?')"><i class="fas fa-times" aria-hidden="true">&nbsp;<span style="font-size:13px;">Delete</span></i></a>
