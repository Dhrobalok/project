        ...
        <div class="table-responsive"> 
         ...
         <div class="Banner">
             ...
             <div class="col-lg-12">
                   ...
                   <p style="text-align: center; font-style: oblique; font-size: 20px;"> @ Exam Notice @ </p>     


 
<form action="{{url('/examnotice2')}}">
     @csrf
...
<tr>
      ...
      <td>
         <input type="text" name="session" class="form-control" placeholder="Enter Session" style="height: 40px; width: 140px;" required="">
           
        </td>

        <td>

         <select name="semester" class="form-control" placeholder="Enter Session" style="height: 40px; width: 140px;" required="">
           <option>1st</option>
            <option>2nd</option>
             <option>3rd</option>
              <option>4th</option>
             ...
             <td>
         <input type="text" name="title" class="form-control" placeholder="Enter Title" style="height: 40px; width: 140px;" required="">
        ...
        <input type="date" name="examdate" class="form-control" style="height: 40px; width: 140px;">
        </td>
