	  ...
	  <div class="row justify-content-start" id="banar">
                ...
                <div class="col-md-2 py-4">
                    ...
                    <div class="d-flex">
                        ...
                        {{-- <hr align="center" style="width:5px;height:77px;color:white;"/> --}}
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                    ...
                                    <li style="font-size:14px;"><a class="dropdown-item" href="{{url('about.hardware',$productall->productitem)}}">  {{$productall->productitem}}</a></li>
