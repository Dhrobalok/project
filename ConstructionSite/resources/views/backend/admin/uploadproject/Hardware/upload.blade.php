    ...
    <div class="row justify-content-center">
        ...
        <div class="card">
            ...
            <div class="card-body shadow-lg">
                <form enctype="multipart/form-data" action="{{ url('hardwar.save') }}"  method="POST" id="form-submit">
                    @csrf
                    ...
                    <div class="row  justify-content-strat">
                        ...
                        <div class="col-md-6">
                            <label>Hardware Image<span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row  justify-content-start">
                        ...
                        <div class="col-md-6">
                            <label>Product item</label><span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row form-group justify-content-center">
                        <div class="col-md-12">
                            ...
                            <select name="item" id="" class="form-control">
                                ...
                                <option value="Metal Sheet/Bar">Metal Sheet/Bar</option>
                                <option value="PVC Pipes & Fittings">PVC Pipes & Fittings</option>
                                <option value="Fire Fighting Equipments">Fire Fighting Equipments</option>
                                <option value="Electrical Item">Electrical Item</option>
                                <option value="Personal Protective Equipments">Personal Protective Equipments</option>
                                <option value="Paints">Paints</option>
                                <option value="Chemicals and Lubricants">Chemicals and Lubricants</option>
                            </select>
