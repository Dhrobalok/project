...
#logo
{
    ...
    <div class="col-md-4">
      ...
      <div class="card">
         <div class="card-header shadow-sm" style="width: 100%;">
            <p class="p-0 m-0 p-2 " style="text-align: center;font-size:15px;color:darkmagenta;"><strong  style="display: inline-block;">Sanitary Details</strong> </p>
            ...
            <table class="table">
                <tbody >
                    ...
                    <tr>
                        ...
                        <td  style="font-family:Franklin Gothic Medium;">Sanitary&nbsp;View</td>
                        <td>:</td>
                        <td> <img class="p-2 zoom" src = "{{ URL :: to($allsanitary -> image) }}" id="logo" alt="Avatar" ></td>
                    </tr>
                    <tr>
                        <td  style="font-family:Franklin Gothic Medium;">Category</td>
                        <td>:</td>
                        <td>{{ $allsanitary->category }}</td>


                    </tr>

                    <tr>
                        <td  style="font-family:Franklin Gothic Medium;">ProductItem</td>
                        <td>:</td>
                        <td>{{ $allsanitary->productitem }}</td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{ $allsanitary->price }}&nbsp;<span style="font-size: 27px;">&#2547;</span></td>
      ...
      <div class="col-md-6">
         ...
         <div class="card">
            ...
            <div class="card-body">
                @php
                $company=App\Models\Compane::where('employe_id',$allsanitary->employee_id)->first();
               @endphp
               ...
               @endphp
                ...
                {{-- <div class="row justify-content-center">
                    ...
                    <p class="py-2" style="text-align: center;">
                        <strong style="color:darkgray;">{{ $allsanitary->description }}
  ...
  <div class="col-md-4 py-4">
    ...
    <div class="card">
      ...
      <div class="card-body">
          <p class="text-center">
             @php
                Mapper::map($allsanitary->lat, $allsanitary->lng);
             @endphp
               ...
               <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                      ...
                      $employeeimage=App\Models\Employee::where('id',$allsanitary->employee_id)->first();
                    ...
                    <p style="font-size: 17px;color:black;text-align:center; width:bold;">
                      <b>Iteam&nbsp;{{ $allsanitary->productitem }}&nbsp;In {{ $allsanitary->address }}</b>
                    ...
                    <p style="font-size: 17px;color:black;text-align:center; width:bold;">
                      @php
                        $email=App\Models\User::where('id',$allsanitary->employee_id)->first();
                      ...
                      <div class="card-header" style="height:width:25%">
                        ...
                        <form action="{{ url('savecontact') }}" method="POST">
                          ...
                          <div class="form-group py-3">
                            ...
                            <input type="hidden" name="size" value="{{ $allsanitary->productitem }}">
                            <input type="hidden" name="id" value="{{ $allsanitary->employee_id }}">
  ...
  $allBrick=App\Models\Sanitar::get();
 @endphp


 <h5 class="text-center text-secondary">SIMILAR SANIATRY</h5>
                         ...
                         <div class="col-md-5 py-2">
                             ...
                             <table class="table table-borderless w-100">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{URL('sanitary/view',$brickall->id)}}" class="text-center">
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-secondary ">{{$brickall->productitem}}&nbsp;Sanitary</h5>
                                     ...
                                     <tr>
                                         <td style="font-family: Franklin Gothic Medium;">Price</td>
                                        <td>:</td>
                                        <td>{{$brickall->price}}&nbsp;<span style="font-family: fantasy;">&#2547;</span>
                                         </td>
                                     ...
                                     <tr>
                                         <td style="font-family: Franklin Gothic Medium;">Sanitary&nbsp;Iteam</td>
                                         <td>:</td>
                                         <td>{{$brickall->productitem}}</td>
                                     </tr>
                                 </tbody>
