    ...
    <div class="col-md-5" style="padding: 80px;">
        ...
        <div class="card" id="card1">
            ...
            <div class="card-header">
                <h5 style="text-align: center;">Search Sand</h5>
              <form action="<?php echo e(route('sand.location')); ?>" method="POST" id="form-submit">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.admin.userdashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\rajit_project\Reda_Construction\resources\views/backend/admin/uploadproject/sandupload/search.blade.php ENDPATH**/ ?>