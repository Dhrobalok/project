...
button {
    ...
    <div class="col-md-4">
      ...
      <div class="card">
         <div class="card-header shadow-sm" style="width: 100%;">
            <p class="p-0 m-0 p-2 " style="text-align: center;font-size:15px;color:darkmagenta;"><strong  style="display: inline-block;">Architecture Details</strong> </p>
         ...
         <div class="card p-3">
            <table class="table">
                <tbody class="text-center">
                    ...
                    <tr>
                        <td style="font-family: Franklin Gothic Medium">Architecture&nbsp;View</td>
                        <td>:</td>
 ...
 $allBrick=App\Models\Architect::get();
@endphp
