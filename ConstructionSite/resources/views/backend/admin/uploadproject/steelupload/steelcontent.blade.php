...
#logo
{
    ...
    <div class="col-md-4">
      ...
      <div class="card">
         <div class="card-header shadow-sm" style="width: 100%;">
            <p class="p-0 m-0 p-2 " style="text-align: center;font-size:15px;color:darkmagenta;"><strong  style="display: inline-block;">Steel Details</strong> </p>
            ...
            <table class="table">
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{ $cementall->price }}&nbsp;<span style="font-size: 27px;">&#2547;</span></td>
               ...
               <div class="col-md-9">
                <div class="card">
                    ...
                    <p style="font-size: 17px;color:black;text-align:center; width:bold;">
                      <b>{{ $cementall->size }}&nbsp;mm&nbsp;In {{ $cementall->locationName }}</b>
                      ...
                      <div class="card-header" style="height:width:25%">
                        ...
                        <form action="{{ url('savecontact') }}" method="POST">
                          ...
                          <div class="form-group py-3">
                            ...
                            <input type="hidden" name="size" value="{{ $cementall->size }}">
                            <input type="hidden" name="id" value="{{ $cementall->employee_id }}">
  ...
  $allBrick=App\Models\Steel::get();
 @endphp


 <h5 class="text-center text-secondary">SIMILAR STEEL</h5>
                         ...
                         <div class="col-md-5 py-2">
                             ...
                             <table class="table table-borderless w-100">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{URL('steel/view',$brickall->id)}}">
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-secondary ">{{$brickall->size}}&nbsp;mm&nbsp;Steel</h5>
