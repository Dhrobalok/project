    ...
    <div class="row justify-content-center">
        ...
        <div class="card">
            ...
            <div class="card-body shadow-lg">
                <form enctype="multipart/form-data" action="{{ url('electric.save') }}"  method="POST" id="form-submit">
                    @csrf
                    ...
                    <div class="row form-group justify-content-center">
                        <div class="col-md-12">
                            ...
                            <select name="item" id="" class="form-control">
                                ...
                                <option value="DRONES & RC HOBBY">DRONES & RC HOBBY</option>
                                <option value="MCU AND COMPUTER KITS">MCU AND COMPUTER KITS</option>
                                <option value="PASSIVE COMPONENTS">PASSIVE COMPONENTS</option>
                                <option value="SMD COMPONENTS">SMD COMPONENTS</option>
                                <option value="SOUND SYSTEMS">SOUND SYSTEMS</option>
                                <option value="SOCKET, PORT & JACKS">SOCKET, PORT & JACKS</option>
