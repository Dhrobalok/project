...
<div class="card shadow mt-4">
              ...
              <div class="border text-center" style="width: 100%; height:auto; background-color:#d5e3eb;">
                <p class="mt-3" style="color: #505354;font-size:1rem;">{{ucwords($titlename->name)}} <span>Information</span></p>
               </div>
                                            ...
                                            @foreach ( $questionAll as $question)
                                              ...
                                              @endphp
                                               ...
                                               @if ($question->name)
                                                  ...
                                                  <input type="radio" name="Q_value[]"   value="{{$question->name}}"><span>&nbsp;{{ucwords($question->name)}}</span>
