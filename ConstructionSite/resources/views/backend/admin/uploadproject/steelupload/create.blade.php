    ...
    <div class="row justify-content-center">
        ...
        <div class="card">
            ...
            <div class="card-body shadow-lg">
                <form  action="{{ route('steel.save') }}"  method="POST" id="form-submit" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row  justify-content-start">
                        ...
                        <div class="col-md-6">
                            <label>Steel Category</label><span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row form-group justify-content-center">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="category"
                             placeholder="Steel Category" required>
                    ...
                    <div class="row  justify-content-strat">
                        ...
                        <div class="col-md-6">
                            <label>Steel Image<span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row  justify-content-start">
                        ...
                        <div class="col-md-6">
                            <label>Steel Size</label><span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row form-group justify-content-center">
                        <div class="col-md-12">
                            ...
                            value="{{ old('mobile_no') }}" placeholder="Steel Size" required>
                    ...
                    <div class="row  justify-content-start">
                        ...
                        <div class="col-md-6">
                            <label>Steel Price</label><span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row form-group justify-content-center">
                        <div class="col-md-12">
                            ...
                            value="{{ old('mobile_no') }}" placeholder="Steel Price" required>
               ...
               <textarea name="description" id="" cols="80" rows="5" class="form-control" required>
