    ...
    <div class="col-md-5" style="padding: 80px;">
        ...
        <div class="card" id="card1">
            ...
            <div class="card-header">
              ...
              <form action="<?php echo e(route('door.location')); ?>" method="POST" id="form-submit">
                    <?php echo csrf_field(); ?>
...
$(document).ready(function (){
    ...
    $.ajax({
        url : "<?php echo e(url('Dooradress.find')); ?>",
        type : "get",
...
<?php echo $__env->make('backend.admin.userdashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\rajit_project\Reda_Construction\resources\views/backend/admin/uploadproject/doorupload/search.blade.php ENDPATH**/ ?>