...
#logo
{
    ...
    <div class="col-md-4">
      ...
      <div class="card">
         <div class="card-header shadow-sm" style="width: 100%;">
            <p class="p-0 m-0 p-2 " style="text-align: center;font-size:15px;color:darkmagenta;"><strong  style="display: inline-block;">Tiles Details</strong> </p>
         ...
         <div class=" card-body">
            <table class="table">
                <tbody class="text-center">
                    <tr>
                        <td style="font-family: Franklin Gothic Medium;">Tiles View</td>
                        <td>:</td>


                            <td><img class="p-2 zoom" src = "{{ URL :: to($alltiles -> image) }}" id="logo" alt="Avatar" ></td>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>{{ $alltiles->price }}<span style="font-size: 27px;">&nbsp;&#2547;</span></td>
      ...
      <div class="col-md-6">
         ...
         <div class="card">
            ...
            <div class="card-body">
                @php
                $company=App\Models\Compane::where('employe_id',$alltiles->employee_id)->first();
               @endphp
              ...
              <table class="table table-borderless w-100">
                ...
                {{-- <div class="row justify-content-center">
                    ...
                    <p class="py-2" style="text-align: center;">
                        <strong style="color:darkgray;">{{ $alltiles->description }}
  ...
  <div class="col-md-4 py-4">
    ...
    <div class="card">
      ...
      <div class="card-body">
          <p class="text-center">
             @php
                Mapper::map($alltiles->lat, $alltiles->lng);
             @endphp
               ...
               <div class="col-md-9">
                <div class="card">
                    <div class="card-header">
                      ...
                      $employeeimage=App\Models\Employee::where('id',$alltiles->employee_id)->first();
                    ...
                    <p style="font-size: 17px;color:black;text-align:center; width:bold;">
                      <b>Size&nbsp;{{ $alltiles->size }}&nbsp;mm&nbsp;In {{ $alltiles->address }}</b>
                    ...
                    <p style="font-size: 17px;color:black;text-align:center; width:bold;">
                      @php
                        $email=App\Models\User::where('id',$alltiles->employee_id)->first();
                      ...
                      <div class="card-header" style="height:width:25%">
                        ...
                        <form action="{{ url('savecontact') }}" method="POST">
                          ...
                          <div class="form-group py-3">
                            ...
                            <input type="hidden" name="size" value="{{ $alltiles->size }}">
                            <input type="hidden" name="id" value="{{ $alltiles->employee_id }}">
  ...
  $allBrick=App\Models\Tile::get();
 @endphp




 <h5 class="text-center text-secondary">SIMILAR TILES</h5>
                                 ...
                                 <tbody>
                                     ...
                                     <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{URL('Tiles/view',$brickall->id)}}">
                                     ...
                                     <tr>
                                        <td>
                                            <h5 class="text-secondary ">{{$brickall->size}}mm&nbsp;Tiles</h5>
                                        </td>
                                     </tr>
                                     <tr>
                                         <td>Price</td>
