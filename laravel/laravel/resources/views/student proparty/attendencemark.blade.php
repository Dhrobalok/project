            ...
            <!-- ... Your content goes here ... -->
             <br><br>
                  ...
                  <div>
                      ...
                      <h3 class="p" style="margin-left: 320px; color: black;"> Pabna University Of Science & Technology</h3>

                      <p class="c"style="margin-left: 340px;">Department Of Computer Science & Engineering</p>
                     ...
                     <div class="head1">
                       ...
                       <form  action="{{url('/studentattend2')}}"  >
                    {{ csrf_field() }}
                      <div class="se1">
...
<script type="text/javascript">
     ...
     $(document).ready(function(){      
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'" class="dynamic-added"><td><input type="text" name="roll[]" placeholder="Enter your roll" class="form-control name_list" /><td><input type="text" name="course[]" placeholder="Enter your course" class="form-control name_list" /></td> <td><input type="text" name="mark[]" placeholder="Enter ct mark" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
      });  
