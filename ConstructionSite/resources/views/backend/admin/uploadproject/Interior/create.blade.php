    ...
    <div class="row justify-content-center">
        ...
        <div class="card">
            ...
            <div class="card-body shadow-lg">
                <form enctype="multipart/form-data" action="{{ url('Interior.save') }}"  method="POST">
                    @csrf
                    ...
                    <div class="row  justify-content-start">
                        ...
                        <div class="col-md-6">
                            <label>Architect Name</label><span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row form-group justify-content-center">
                        <div class="col-md-12">
                            ...
                            value="{{ old('mobile_no') }}" placeholder="Architect Name" required>
                            @if($errors -> has('name'))
                    ...
                    <div class="row  justify-content-strat">
                        ...
                        <div class="col-md-6">
                            <label>IAB Member<span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row form-group justify-content-center">
                        ...
                        <div class="col-md-2">
                           ...
                           <input type="checkbox" name="iabmember" value="yes">&nbsp;Yes
                       ...
                       <div class="col-md-2">
                        ...
                        <input type="checkbox" name="iabmember" value="No">&nbsp;No
                    ...
                    <div class="row  justify-content-start">
                        ...
                        <div class="col-md-6">
                            <label>Designation</label><span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row form-group justify-content-center">
                        <div class="col-md-12">
                            ...
                            value="{{ old('mobile_no') }}" placeholder="Designation" required>
                            @if($errors -> has('name'))
                            <small>{{ $errors -> first('name') }}</small>
                            @endif
                        </div>
                    ...
                    <div class="row  justify-content-start">
                        ...
                        <div class="col-md-6">
                            <label>Institution Name</label><span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row form-group justify-content-center">
                        <div class="col-md-12">
                            ...
                            value="{{ old('mobile_no') }}" placeholder="Institution Name" required>
                            @if($errors -> has('name'))
                            <small>{{ $errors -> first('name') }}</small>
                            @endif
                        </div>
                       ...
                       type="text/javascript"></script>
                            ...
                            <div class="row form-group justify-content-start">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="file" class="form-control"  name="image" placeholder="Address" required>
