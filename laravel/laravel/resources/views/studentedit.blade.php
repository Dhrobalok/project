...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <ul class="nav navbar-right navbar-top-links">
           ...
           <li class="dropdown">
    <a href="javascript:void(0)" class="dropbtn"><i class="fa fa-user fa-fw"> </i>Admin</a>
    <div class="dropdown-content">
      <a href="#"><i class="fa fa-user fa-fw"></i>UserProfile</a>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                   <form action="{{url('/studentapprove',$re->id)}}" method="POST" enctype="multipart/form-data">
                     {{ csrf_field() }}
                  ...
                  <br>
                    ...
                    <br>
                      ...
                      <th><span style="color: white;">Name:</span></th>
                        <th><span style="color: white;">Email:</span></th>
                          ...
                          <th><span style="color: white;">Session:</span></th>
                            <th><span style="color: white;">Roll:</span></th>
                               <th><span style="color: white;">Blood:</span></th>
                            <th><span style="color: white;">Image:</span></th>
                              
                               
                                    <th><span style="color: white;">Mobile:</span></th>
                   ...
                   <td>
                 <input type="text" name="name" value="{{$re->name}}">
                   </td>

                     <td>
                  <input type="email" name="email" value="{{$re->email}}">
                   </td>

                     <td>
                  <input type="password" name="password" value="{{$re->password}}">
                   </td>

                      <td>
                  <input type="text" name="session" value="{{$re->session}}">
                   </td>

                       <td>
                  <input type="text" name="roll" value="{{$re->roll}}">
                   </td>

                         <td>
                 <input type="text" name="blood" value="{{$re->blood}}">
                   </td>

                 <td>
                 <input type="text" name="image" value="{{$re->image}}">
                   </td>

        

                       <td>
                 <input type="text" name="mobile" value="{{$re->mobile}}">
                   </td>
                     
           

                     <td>
                     <button class="btn btn-primary">ApproveConfirm</button>
                   </td>
                     </tr>
