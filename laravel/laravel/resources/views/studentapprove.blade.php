            ...
            <div class="row">
                <div class="col-lg-12">
                 ...
                 {{$re->mobile}}
                     ...
                     <a href="{{URL::to('/studentedit/'.$re->id)}}"><button class="btn btn-primary">Approve</button></a>
                
                   
                     <a href="{{URL::to('/studelet/'.$re->id)}}"><button class="btn btn-danger">Delete</button></a>
                    <!-- <a href="{{URL::to('/studelet/'.$re->id)}}"><button class="btn btn-red">Delete</button></a>-->
                   </td>
                     </tr>
                    @endforeach
