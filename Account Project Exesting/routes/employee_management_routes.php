...
use App\Http\Controllers\EmployeeManagement\EmployeeSectionController;
    ...
    Route :: prefix('employee-management')->group(function(){
     ...
     Route :: prefix('employees')->group(function(){
       Route :: get('/',[EmployeeRegistrationController :: class, 'index'])->name('admin.employee-management.employees.index')->middleware('permission:view employees');
       Route :: get('view/{employee_id}',[EmployeeRegistrationController :: class,'view'])->name('admin.employee-management.employees.view')->middleware('permission:view employees');
       Route :: get('approve/{employee_id}',[EmployeeRegistrationController :: class,'approve'])->name('admin.employee-management.employees.approve')->middleware('permission:view employees');
       Route :: post('delete',[EmployeeRegistrationController :: class,'delete'])->name('admin.employee-management.employees.delete')->middleware('permission:delete employees');
