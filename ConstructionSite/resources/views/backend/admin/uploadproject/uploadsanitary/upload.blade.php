    ...
    <div class="row justify-content-center">
        ...
        <div class="card">
            ...
            <div class="card-body shadow-lg">
                <form enctype="multipart/form-data" action="{{ route('saniatry.save') }}"  method="POST" id="form-submit">
                    @csrf
                    ...
                    <div class="row  justify-content-strat">
                        ...
                        <div class="col-md-6">
                            <label>Sanitary Image<span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row form-group justify-content-center">
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="item" id="size"
                            value="{{ old('mobile_no') }}" placeholder="item" required>
