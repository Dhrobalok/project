                    ...
                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full  bg-white">
                        <thead>
                            <tr>
                                ...
                                <th class="d-none d-sm-table-cell text-center">Tenure Year(s)</th>
                                <th class="d-none d-sm-table-cell text-center">EMI</th>
                                <th class="d-none d-sm-table-cell text-center">Loan Ref. No</th>
                        ...
                        <tbody>
                            @foreach($loans as $loan)
                             @php 
                               $already_approved = App\Models\LoanApprove :: where('loan_id',$loan -> id)->where('status',1)->count();
                               $current_approver_order = App\Models\LoanApprove :: where('loan_id',$loan -> id)
                                        ...
                                        <div class="btn-group">
                                           @can('approve loans')
                                            <a class="btn btn-sm btn-outline-success"
                                                href="{{ route('admin.loan.approve',['loan_id' => $loan -> id]) }}"
