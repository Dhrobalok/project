    ...
    <div class="card-body">
        <table class="table table-sm table-reponsive table-bordered table-striped table-vcenter js-dataTable-full">
            ...
            <tbody>
                ...
                @php
                    $update=App\Models\User::where('id',$employee->user_id)->first();
                @endphp
                <tr id="{{ $employee -> id }}" class = "text-center">
                    ...
                    <div class="list-group">
                        ...
                        <a href="{{ route('admin.employees.aprove',['employee_id' => $employee -> id]) }}" class="list-group-item list-group-item-action" style = "color:green;display:none"><i style = "color:green" class = "fa fa-pencil-alt mr-2"></i>Aprove</a>
                        @endcan
                        ...
                        <a href="#" onclick="delete_confirm(event,{{ $employee -> id}})" class="list-group-item list-group-item-action" style = "color:red;display:none"><i style = "color:red" class = "fa fa-trash-alt mr-2"></i>Delete</a>
                        @endcan
    ...
    function delete_confirm(event,employee_id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "{{ route('admin.employee-management.employees.delete') }}",
                    type: "post",
                    data:
                    {
