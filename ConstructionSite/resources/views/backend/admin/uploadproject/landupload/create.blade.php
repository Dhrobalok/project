    ...
    <div class="row justify-content-center">
        ...
        <div class="card">
            ...
            <div class="card-body shadow-lg">
                <form enctype="multipart/form-data" action="{{ route('land.save') }}"  method="POST" id="form-submit">
                    @csrf
                    ...
                    <div class="row form-group justify-content-center">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="area"
                             placeholder="Land Area" required>
                    ...
                    <div class="row  justify-content-strat">
                        ...
                        <div class="col-md-6">
                            <label>Land Image<span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row  justify-content-start">
                        ...
                        <div class="col-md-6">
                            <label>Land Size</label><span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row form-group justify-content-center">
                        <div class="col-md-12">
                            ...
                            value="{{ old('mobile_no') }}" placeholder="Land Size" required>
                    ...
                    <div class="row  justify-content-start">
                        ...
                        <div class="col-md-6">
                            <label>Land Price</label><span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row form-group justify-content-center">
                        <div class="col-md-12">
                            ...
                            value="{{ old('mobile_no') }}" placeholder="Land Price" required>
                    ...
                    <div class="row  justify-content-strat">
                        ...
                        <div class="col-md-6">
                            <label>Land Picture<span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="row form-group justify-content-start">
                        ...
                        <div class="col-md-12">
                            {{-- < class="form-control" onclick="myFunction()" ><i class="fa fa-map-marker" aria-hidden="true"></i></> --}}
                            <input type="file" class="form-control"  name="landpic" placeholder="Location Name" required>
                            {{-- <input type="hidden" class="form-control"  id="lat" name="lat" placeholder="location">
                            <input type="hidden" class="form-control" placeholder="lng" name="lng" id="lng"> --}}
                            @if($errors -> has('email'))
                            <small>{{ $errors -> first('email') }}</small>
