                ...
                <div class="content-side">
                    <ul class="nav-main">
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="{{ route('Adminindex') }}">
                        ...
                        @endphp
                        <li class="nav-main-item {{ $is_role_tab_active == true ? 'open' : ''}}">
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                <li
                                    class="nav-main-item {{ $is_role_tab_active == true ? 'current-active-link' : '' }}">
                                ...
                                <li
                                    class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('admin.payroll.settings.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                         ...
                         @endif --}}
                        {{-- @if($user -> hasRole(['Administration','Accountant'])) 
                        @php
                        $path = request() -> path();
                        ...
                        <li class="nav-main-item ">
                             {{-- @can('view cost') --}}
                            <a class="nav-main-link" href="{{ route('cost-center-index') }}">
                            ...
                            <li class="nav-main-item">
                             ...
                             {{-- @endcan --}}
                                ...
                                <li class="nav-main-item ">
                                    <a class="nav-main-link" href="{{ route('accounts.index') }}">
                                    <i class="nav-main-link-icon fas fa-file-invoice"></i>
                                ...
                                {{-- @can('view cheque') --}}
                                <li class="nav-main-item ">
                                    <a class="nav-main-link" href="{{ route('admin.cheque-book.index') }}">
                                        <i class="nav-main-link-icon fas fa-file-invoice"></i>
                                ...
                                {{-- @can('approve_setup vouchers') --}}
                                    ...
                                    {{-- <a class="nav-main-link" href="{{ route('admin.approver.index') }}">
                                        <i class="nav-main-link-icon fas fa-file-invoice"></i>
                                ...
                                {{-- @can('view vouchers') --}}
                                <li class="nav-main-item ">
                                    <a class="nav-main-link" href="{{ route('admin.voucher.approved') }}">
                                        <i class="nav-main-link-icon fas fa-file-invoice"></i>
                                    ...
                                    <a class="nav-main-link"
                                        href="{{ route('admin.employee-management.employees.index') }}">
                                        <i class="nav-main-link-icon fas fa-file-invoice"></i>
                                        <span class="nav-main-link-name">Approve Student</span>
                                    </a>
                                    ...
                                    {{-- <a class="nav-main-link" href="{{ route('admin.voucher.rejected') }}">
                                        <i class="nav-main-link-icon fas fa-file-invoice"></i>
                                        <span class="nav-main-link-name">Backwarded Vouchers</span>
                                    </a> --}}
                                
                                <li class="nav-main-item ">
                                    <a class="nav-main-link" href="{{ route('admin.voucher.generated') }}">
                                        <i class="nav-main-link-icon fas fa-file-invoice"></i>
                                ...
                                <li class="nav-main-item ">
                                    <a class="nav-main-link" href="{{ route('BackwardVoucher') }}">
                                        <i class="nav-main-link-icon fas fa-file-invoice"></i>
                                        <span class="nav-main-link-name">Backward Vouchers</span>
                                    </a>
                                </li>
                            ...
                            <li class="nav-main-item ">
                                ...
                                <a class="nav-main-link"
                                    ...
                                    <i class="nav-main-link-icon fas fa-file-invoice"></i>
                                    <span class="nav-main-link-name">Teacher Add</span>
                                </a>
                            </li>

                            <li class="nav-main-item ">
                                <a class="nav-main-link"
                                href="{{ route('teacher.alocation') }}">
                                <i class="nav-main-link-icon fas fa-file-invoice"></i>
                                <span class="nav-main-link-name">Teacher Allocation </span>
                               </a>
                            </li>
                            {{-- <li class="nav-main-item ">
                               <a class="nav-main-link"
                               ...
                               <i class="nav-main-link-icon fas fa-file-invoice"></i>
                               <span class="nav-main-link-name">Thesis Bill </span>
                              </a>
                            </li> --}}
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                                    ...
                                    <span class="nav-main-link-name">Fellowship Bill</span>
                                </a>
                                <ul class="nav-main-submenu">
    
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" href="{{ route('Admin.fellowship') }}">
                                            <i class="nav-main-link-icon far fa-circle"></i>
                                            <span class="nav-main-link-name">Fellowship Bill student</span>
                                        </a>
                                    </li>

                                    <li class="nav-main-item ">
                                      <a class="nav-main-link" href="{{ route('Thesis.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Fellowship Bill supervisor </span>
                                     </a>
                                     </li>

                                    <li class="nav-main-item">
                                        <a class="nav-main-link" href="{{ route('Fellow.index') }}">
                                            <i class="nav-main-link-icon far fa-circle"></i>
                                            <span class="nav-main-link-name">FellowShip Index</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                              ...
                              {{-- <li class="nav-main-item ">
                                    ...
                                    <li class="nav-main-item ">
                                    <a class="nav-main-link" href="{{ route('Payslip.add') }}">
                                        <i class="nav-main-link-icon fas fa-file-invoice"></i>
                                        <span class="nav-main-link-name">Payslip </span>
                                    </a>
                                    </li>
                                    <li class="nav-main-item ">
                                    <a class="nav-main-link" href="{{ route('Transfer.create') }}">
                                        <i class="nav-main-link-icon fas fa-file-invoice"></i>
                                        <span class="nav-main-link-name">Found Transfer</span>
                                    </a>
                                  </li>

                                  <li class="nav-main-item ">
                                    <a class="nav-main-link" href="{{ route('Pay.create') }}">
                                        <i class="nav-main-link-icon fas fa-file-invoice"></i>
                                        <span class="nav-main-link-name">Pay Bill</span>
                                    </a>
                                  </li>
                                    ...
                                    {{-- <a class="nav-main-link" href="{{ route('admin.bill-users.index') }}"> 
                                        <i class="nav-main-link-icon fas fa-file-invoice"></i>
                                ...
                                <!-- <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('admin.loan.set-approvers') }}">
                                    <i class="nav-main-link-icon far fa-circle"></i>
                                ...
                                --}}
                                {{-- @endcan --}}
                                {{-- @can('account_setup account') --}}
                               
                                    {{-- <a class="nav-main-link" href="{{ route('admin.bank-reconciliation') }}"> 
                                        <i class="nav-main-link-icon fas fa-file-invoice"></i>
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('admin.cost-center.type.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('admin.partial.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('bulk.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                    ...
                    <li class="nav-main-item">
                        ...
                        <ul class="nav-main-submenu">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{ route('gtc.index') }}">
                                    <i class="nav-main-link-icon far fa-circle"></i>
                    ...
                    <li class="nav-main-item">
                        ...
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item ">
                                <a class="nav-main-link" href="{{URL::to('/fdr')}}">
                                    <i class="nav-main-link-icon far fa-circle"></i>
                        ...
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item ">
                                <a class="nav-main-link" href="{{URL::to('/viewfdr')}}">
                                    <i class="nav-main-link-icon far fa-circle"></i>
                    ...
                    <!--  fdr MANAGEMENT  -->
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('admin.sales.vendors.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Vendors</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('admin.sales.customers.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                        ...
                        @if($user -> hasRole(['Administration','Budget Manager']))
                        @php
                        ...
                        @endphp
                        <li class="nav-main-item {{ $is_budget_tab_active == true ? 'open' : ''}}">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                                aria-expanded="false" href="#">
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                <!-- <li class="nav-main-item {{ $route_prefix_budget == 'budget-accountings' ? 'current-active-link':'' }}">
                                    <a class="nav-main-link" href="{{ route('budget-levels.index') }}">
                                    <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Project Labels</span>
                                    </a>
                                </li>

                                <li class="nav-main-item {{ $route_prefix_budget == 'budgets' ? 'current-active-link':''}}">
                                    <a class="nav-main-link" href="{{ route('budgets.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                ...
                                <li
                                    class="nav-main-item {{ $route_prefix_budget == 'budget-accountings' ? 'current-active-link':'' }}">
                                    <a class="nav-main-link" href="{{ route('budget-accountings.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                ...
                                <li class="nav-main-item {{ $route_prefix_budget == 'budget-accountings' ? 'current-active-link':'' }}">
                                    <a class="nav-main-link" href="{{ route('budget-check-report-start') }}">
                                    <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Budget Check</span>
                                    </a>
                                </li>
                                <li class="nav-main-item {{ $route_prefix_budget == 'budget-accountings' ? 'current-active-link':'' }}">
                                    <a class="nav-main-link" href="{{ route('budget-control-report-start') }}">
                                    <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Budget Control</span>
                                    </a>
                                </li> -->
                                <li class="nav-main-item {{ $route_prefix_budget == 'budget-accountings' ? 'current-active-link':'' }}">
                                    <a class="nav-main-link" href="{{ route('admin.budget.status') }}">
                                    <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Current Status</span>
                                    </a>
                                </li>
                                <li class="nav-main-item ">
                                    <a class="nav-main-link" href="{{ route('admin.budget.define') }}">
                                    <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Define Budget</span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-main-item ">
                                    <a class="nav-main-link" href="{{ route('admin.advancebudget.index') }}">
                                    <i class="nav-main-link-icon far fa-circle"></i>
                        ...
                        @endif
                        @if($user -> hasRole(['Administration','Payroll Manager']))
                        @php
                        ...
                        @endphp
                        <li class="nav-main-item {{ $is_payroll_tab_active == true ? 'open' : '' }}">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                                aria-expanded="false" href="#">
                            ...
                            <ul class="nav-main-submenu">
                                @can('view employees')
                                <li
                                    class="nav-main-item {{ in_array($route_prefix_payroll,['employees','view-employee','view-payslip']) == true ? 'current-active-link':'' }}">
                                    <a class="nav-main-link"
                                        href="{{ route('admin.employee-management.employees.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                               ...
                               <li
                                    class="nav-main-item {{ $route_prefix_payroll == 'department' ? 'current-active-link':'' }}">
                                    <a class="nav-main-link"
                                        href="{{ route('admin.employees.division.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                ...
                                <li
                                    class="nav-main-item {{ $route_prefix_payroll == 'department' ? 'current-active-link':'' }}">
                                    <a class="nav-main-link"
                                        href="{{ route('admin.employees.department.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                ...
                                <li
                                    class="nav-main-item {{ $route_prefix_payroll == 'department' ? 'current-active-link':'' }}">
                                    <a class="nav-main-link"
                                        href="{{ route('admin.employees.section.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Sections</span>
                                    </a>
                                </li>
                                <li
                                    class="nav-main-item {{ $route_prefix_payroll == 'designation' ? 'current-active-link':'' }}">
                                    <a class="nav-main-link"
                                        href="{{ route('admin.employee-management.employee-designation.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Designations</span>
                                    </a>
                                </li>
                                <li
                                    class="nav-main-item {{ $route_prefix_payroll == 'grade' ? 'current-active-link':'' }}">
                                    <a class="nav-main-link" href="{{ route('admin.salary-management.grade.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                        ...
                        <li class="nav-main-item {{ $is_payroll_tab_active == true ? 'open' : '' }}">
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                @can('view payroll')
                                <li
                                    class="nav-main-item {{ $route_prefix_payroll == 'pay-scale' ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link"
                                        href="{{ route('admin.salary-management.payscale.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Pay Scales</span>
                                    </a>
                                </li>
                                <li
                                    class="nav-main-item {{ $route_prefix_payroll == 'salary-segment' ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link" href="{{ route('admin.salary-segment.distribution') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Segment Wise Distribution</span>
                                    </a>
                                </li>
                                <li
                                    class="nav-main-item {{ in_array($route_prefix_payroll,['view-salary','salary-sheets','generated-salary-preview']) == true ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link" href="{{ route('admin.salary-generation.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                ...
                                @can('view festivals')
                                <li
                                    class="nav-main-item {{ in_array($route_prefix_payroll,['set-bonus','festivals']) == true ? 'current-active-link':'' }}">
                                    <a class="nav-main-link" href="{{ route('admin.festival.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                ...
                                <li
                                    class="nav-main-item {{ $route_prefix_payroll == 'general-payroll-report-start' ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link" href="{{ route('payroll-report-start') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                        ...
                        @endif
                        @if($user -> hasRole(['Administration','Pension Manager']))
                        @php
                        ...
                        @endphp
                        <li class="nav-main-item {{ $is_pension_tab_active == true ? 'open' : '' }}">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                                aria-expanded="false" href="#">
                                <i class="nav-main-link-icon fas fa-file-invoice-dollar"></i>
                            ...
                            <ul class="nav-main-submenu">
                                @can('view pension')
                                <li
                                    class="nav-main-item {{ in_array($route_prefix_pension,['pension-users']) == true ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link" href="{{ route('admin.pension-users.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Pensions of Users</span>
                                    </a>
                                    <a class = "nav-main-link" href = "{{ route('admin.pension-user.approval-pendings') }}">
                                    <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Pending Pensions Users</span>
                                    </a>
                                </li>
                                @endcan
                                @can('generate pension')
                                <li
                                    class="nav-main-item {{ $route_prefix_pension == 'pension-process' ? 'current-active-link' : ''}}">
                                    <a class="nav-main-link" href="{{ route('admin.pension-process.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                        ...
                        <!-- </li> -->
                        @endif
                        @if($user -> hasRole(['Administration','Provident Fund Manager']))
                        @php
                        ...
                        @endphp
                        <!-- <li class="nav-main-item {{ $is_gratuity_tab_active == true ? 'open' : '' }}"> -->
                            <!-- <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                                aria-expanded="false" href="#">
                                <i class="nav-main-link-icon fas fa-file-invoice-dollar"></i>
                            ...
                            <ul class="nav-main-submenu">
                                <li
                                    class="nav-main-item {{ $route_prefix_gratuity == 'gratuity-users' ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link" href="{{ route('admin.gratuity-users.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Gratuity of Users</span>
                                    </a>
                                    <a class = "nav-main-link" href = "{{ route('admin.gratuity-user.approval-pending') }}">
                                    <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Pending Gratuity</span>
                                    </a>
                                </li>
                                <!-- <li
                                    class="nav-main-item {{ $route_prefix_gratuity == 'gratuity-process' ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link" href="{{ route('admin.gratuity-process.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                        ...
                        <li class="nav-main-item {{ $is_provident_tab_active == true ? 'open' : '' }}">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                                aria-expanded="false" href="#">
                                <i class="nav-main-link-icon fas fa-file-invoice-dollar"></i>
                            ...
                            <ul class="nav-main-submenu">
                                @can('view provident')
                                <li
                                    class="nav-main-item {{ $route_prefix_provident_fund == 'pf-contribution' ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link" href="{{ route('admin.pf-contribution.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                            ...
                            <ul class="nav-main-submenu">
                                <li
                                    class="nav-main-item {{ $route_prefix_provident_fund == 'pf-loan' ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link" href="{{ route('admin.pf-loan.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item {{ $route_prefix_provident_fund == 'config-app-panel' ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link" href="{{ route('pfdr.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                            ...
                            <ul class="nav-main-submenu">
                                <li
                                    class="nav-main-item {{ $route_prefix_provident_fund == 'config-app-panel' ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link" href="{{ route('admin.pf-loan.approval-panel-config') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                            ...
                            <ul class="nav-main-submenu">
                                <li
                                    class="nav-main-item {{ $route_prefix_provident_fund == 'config-app-panel' ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link" href="{{ route('admin.pf-loan.pending-loans') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                        ...
                        @endif
                        @if($user -> hasRole(['Administration','House Building Loan Manager']))
                        @php
                        ...
                        @endphp
                        <li class="nav-main-item {{ $is_loan_tab_active == true ? 'open' : '' }}">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                                aria-expanded="false" href="#">
                                <i class="nav-main-link-icon fas fa-file-invoice-dollar"></i>
                            ...
                            <ul class="nav-main-submenu">
                                @can('view loans')
                                <li
                                    class="nav-main-item {{ $route_prefix_loan == 'house-loan' ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link" href="{{ route('admin.loan.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Loans</span>
                                    </a>
                                </li>
                                @endcan
                                @can('approve_setup loans')
                                <li
                                    class="nav-main-item {{ $route_prefix_loan == 'config-approval-panel' ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link" href="{{ route('admin.loan.set-approvers') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                ...
                                @can('approve loans')
                                <li
                                    class="nav-main-item {{ $route_prefix_loan == 'pending-loans' ? 'current-active-link' : '' }}">
                                    <a class="nav-main-link" href="{{ route('admin.loan.pending-loans') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
                                        <span class="nav-main-link-name">Pending Loans</span>
                                    </a>
                                </li>
                                ...
                                <li
                                    class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('admin.loan.waiting.index') }}">
                                        <i class="nav-main-link-icon far fa-circle"></i>
            ...
            <div class="content-header">
                ...
                <div>
                 ...
                 <div class="dropdown">
                   ...
                   <a class="dropdown-item" href="{{ route('admin.voucher.debit.index') }}">Payment Vouchers</a>
                   <a class="dropdown-item" href="{{ route('admin.voucher.credit.index') }}">Receive Vouchers</a>
                   {{--
                   <a class="dropdown-item"href="route('admin.voucher.expenditure.index') }}">Expenditure Vouchers</a>
                   <a class="dropdown-item" href="{{ route('admin.voucher.transfer.index') }}">Transfer Vouchers</a>
                   --}}
                   <a class="dropdown-item" href="{{ route('admin.voucher.journal.index') }}">Journal Vouchers</a>
                   <a class="dropdown-item" href="#">Misc. Vouchers</a>
                   <!--<a class="dropdown-item" href="{{ route('advancevoucher') }}">Advanced Vouchers</a>-->

                   <!-- <a class="dropdown-item" href="{{ route('admin.bill-vouchers.index') }}">Bill Vouchers</a> -->
                   </div>
                </div>
                 </div>
                 ...
                 <div class="dropdown">
                   ...
                   <a class="dropdown-item" href="{{ route('trial-balance-report-start') }}">Trial Balance Report</a>
                   <a class="dropdown-item" href="{{ route('cash-book-report-start') }}">Cash Book Report</a>
                   {{-- <a class="dropdown-item" href="{{ route('ThesisBill.report') }}">Thesis Bill Report</a> --}}
                   {{-- <a class="dropdown-item" href="{{ route('FellowBill.report') }}">Fellow Bill Report</a> --}}
                   {{-- <a class="dropdown-item" href="{{ route('profitloss.report') }}">Profit and Loss Report </a> --}}
                   
                   {{-- <a class="dropdown-item" href="{{ route('invoice') }}">Bulk Invoice Form</a> --}}
                   {{-- <a class="dropdown-item" href="{{ route('admin.reports.reconciliation.index') }}">Reconciliation Report</a> --}}
                   {{-- <a class="dropdown-item" href="{{ route('admin.report.cost-center.index') }}">Cost Center Report</a> --}}
                   <a class="dropdown-item" href="{{ route('view-balance-sheet') }}">Balance Sheet</a>
                   {{-- <a class="dropdown-item" href="{{ route('payroll-report-start') }}">Payroll Report</a> --}}
                   {{-- <a class="dropdown-item" href="{{ route('admin.report.pf.index') }}">Provident Fund Report</a> --}}
                   {{-- <a class="dropdown-item"  href="{{ route('agreement.download') }}">Vat_Tax_Comssion_Report of Stone Salling</a> --}}
                   <!--a class="dropdown-item"  href="{{ route('daily_stone_selling_report.download') }}">Dailly Stone salling Report</a-->
                   {{-- <a class="dropdown-item" href="{{ route('gtc.report') }}">Gtc Report</a> --}}
                   {{-- <a class="dropdown-item" href="{{ route('bulk.duration') }}">Bulk Report</a> --}}
            ...
            <div class="content py-0">
                <div class="row font-size-sm">
                    ...
                    <div class="col-sm-6 order-sm-1 text-center text-sm-left">
                        <a class="font-w600" href="#" target="_blank">IBSC Accouting System</a> &copy; <span
